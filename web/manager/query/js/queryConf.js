...
var QueryConfBean = new Bean("com.cicro.wcm.bean.query.QueryConfBean",true);
...
{
	if(type ==1){
		window.location.href = "/manager/query/query_dic.jsp?conf_id="+conf_id+"&site_id="+site_id;
	}else if(type ==2){
		window.location.href = "/manager/query/query_upload.jsp?conf_id="+conf_id+"&site_id="+site_id;
	}else{
		window.location.href = "/manager/query/query_infoLists.jsp?conf_id="+conf_id+"&site_id="+site_id;
	}	
}
...
{
	window.location.href = "/manager/query/query_conf_add.jsp?site_id="+site_id;		
}

function openUpdatePage(site_id)
{
	var selectIDS = table.getSelecteCheckboxValue("conf_id");
	window.location.href = "/manager/query/query_conf_add.jsp?site_id="+site_id+"&conf_id="+selectIDS;
}

function openUpdatePage2(conf_id)
{
	window.location.href = "/manager/query/query_conf_add.jsp?site_id="+site_id+"&conf_id="+conf_id;
}
