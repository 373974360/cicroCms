...
var QueryItemBean = new Bean("com.cicro.wcm.bean.query.QueryItemBean",true);
...
{
	window.location.href = "/manager/query/query_infoAdd.jsp?site_id="+site_id+"&conf_id="+conf_id;	
}
...
function openUpdatePage(site_id,conf_id)
{
	...
	window.location.href = "/manager/query/query_infoModify.jsp?site_id="+site_id+"&conf_id="+conf_id+"&item_id="+selectIDS;
}
