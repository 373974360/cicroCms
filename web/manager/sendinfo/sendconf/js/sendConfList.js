...
var SendConfigBean = new Bean("com.cicro.wcm.bean.sendInfo.SendConfigBean",true);
...
{
	top.addTab(true,"/manager/sendinfo/sendconf/add_sendconf.jsp?topnum="+top.curTabIndex,"报送配置");
}
...
function openUpdateSendConfigPage(s_id)
{
	...
	top.addTab(true,"/manager/sendinfo/sendconf/add_sendconf.jsp?site_id="+id+"&topnum="+top.curTabIndex,"报送配置");
}
