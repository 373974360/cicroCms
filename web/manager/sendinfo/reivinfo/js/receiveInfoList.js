...
var ReceiveInfoBean = new Bean("com.cicro.wcm.bean.sendInfo.ReceiveInfoBean",true);
...
{
	top.addTab(true,"/manager/sendinfo/reivinfo/sendinfoView.jsp?id="+id,"查看信息");
}
...
{
	adopt_desc = desc;
	top.OpenModalWindow("不采用意见","/manager/sendinfo/reivinfo/adopt_desc.jsp?type=-1",520,235);
}
...
function adoptReceiveInfo(flag,info_status)
{
	...
	{
		top.OpenModalWindow("不采用意见","/manager/sendinfo/reivinfo/adopt_desc.jsp",520,235);
	}
}
