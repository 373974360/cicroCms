...
<script type="text/javascript" src="js/receiveInfoCount.js"></script>
...
function setCountCon()
{
	...
	{
		m.put("s_site_id",t_site_ids.substring(1));
	}else
	{
...
function funOKCate()
{
	getReceiveCateListForRecord();
}

function getReceiveCateListForRecord()
{
	if(setCountCon())
	{
		$("#treeTableCount").show();
		var l = SendInfoRPC.getReceiveCateListForRecord(m);
		l = List.toJSList(l);
		var treeHtmls = "";
		...
		<tr>
			<td align="left" valign="middle" colspan="2">
				<ul class="inputUL" id="b_tr"> 
					<li><label class="f_red">*</label>报送站点：&nbsp;&nbsp;<input type="checkbox" name="all" id="all" value="1" onclick="fnAll()" style="vertical-align:middle"><b><label onclick="fnAllSet()">全选</label></b></li>
				</ul>
				<span class="blank3"></span>
			</td>
	</tr>
