...
var ReceiveConfigBean = new Bean("com.cicro.wcm.bean.sendInfo.ReceiveConfigBean",true);
var ReceiveCatConf = new Bean("com.cicro.wcm.bean.sendInfo.ReceiveCatConf",true);
...
{
	top.addTab(true,"/manager/sendinfo/reivconf/add_reivconf.jsp?topnum="+top.curTabIndex,"报送配置");
}
...
function openUpdateReceiveConfigPage(s_id)
{
	...
	top.addTab(true,"/manager/sendinfo/reivconf/add_reivconf.jsp?site_id="+id+"&topnum="+top.curTabIndex,"报送配置");
}
