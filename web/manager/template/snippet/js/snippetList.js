...
{
	top.OpenModalWindow("新建代码片段信息","/manager/template/snippet/snippet_add.jsp?type=add&app="+app+"&site_id="+site_id,450,239);
}
function openUpdateSnippetPage(id)
{
	top.OpenModalWindow("维护代码片段信息","/manager/template/snippet/snippet_add.jsp?type=update&id="+id,450,239);
}
// 修改代码片断信息
function updateRecord1()
{  
	var id = table.getSelecteCheckboxValue("id");
	top.OpenModalWindow("修改代码片段信息","/manager/template/snippet/snippet_add.jsp?type=update&id="+id,450,239);
}
