...
function addActor()
{
	...
	top.addTab(true,"/manager/interview/subject/add_actor.jsp?sub_id="+sub_id+"&topnum="+top.curTabIndex,"维护嘉宾信息");
}
...
function fnUpdateActor()
{
	...
	top.addTab(true,"/manager/interview/subject/add_actor.jsp?id="+selectIDS+"&topnum="+top.curTabIndex,"维护嘉宾信息");
}
...
{	
	...
	top.addTab(true,"/manager/interview/subject/add_actor.jsp?id="+id+"&topnum="+top.curTabIndex,"维护嘉宾信息");
}
...
{	
	//top.addTab(true,'/manager/interview/subject/view_actor.jsp?id='+id,'查看嘉宾信息');
	//window.location.href = '/manager/interview/subject/add_actor.jsp?id='+id;
	top.addTab(true,"/manager/interview/subject/add_actor.jsp?id="+id+"&topnum="+top.curTabIndex,"查看嘉宾信息");
}