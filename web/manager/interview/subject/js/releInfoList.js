	...
	var subjectReleInfo = new Bean("com.cicro.wcm.bean.interview.SubReleInfo",true);
...
function addReleInfo()
{
	...
	top.addTab(true,"/manager/interview/subject/add_releInfo.jsp?sub_id="+sub_id+"&topnum="+top.curTabIndex,"维护信息");
}
...
function fnUpdateReleInfo()
{
	...
	else
	{
		...
		top.addTab(true,"/manager/interview/subject/add_releInfo.jsp?id="+selectIDS+"&topnum="+top.curTabIndex,"维护信息");
	}
}
...
{	
	...
	top.addTab(true,"/manager/interview/subject/add_releInfo.jsp?id="+id+"&topnum="+top.curTabIndex,"维护信息");
}
...
{	
	//top.addTab(true,'/manager/interview/subject/view_releInfo.jsp?id='+id,'查看信息内容');
	//window.location.href = '/manager/interview/subject/add_releInfo.jsp?id='+id;
	top.addTab(true,"/manager/interview/subject/add_releInfo.jsp?id="+id+"&topnum="+top.curTabIndex,"查看信息");
}