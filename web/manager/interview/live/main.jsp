...
<head> 
	...
	.text_div{height:200px;border-left:1px solid #A0B2C8;border-right:1px solid #A0B2C8;border-bottom:1px solid #A0B2C8;overflow:auto;background:#F5FAFE;padding:3px;color:#486282}
	.editor_div{border-left:1px solid #A0B2C8;border-right:1px solid #A0B2C8;border-bottom:1px solid #A0B2C8;background:#F5FAFE;padding:3px;color:#486282}
	...
	<!--
		...
		$(document).ready(function () {		
			...
			isShowText();
			getMessage();
			init_editer_simple("elem2");
			init_editer_simple("elem1");
			initButtomStyle();
			init_input();
		}); 
		//根据页面高度自动设置DIV高度
...
//////////////-2013-1-23-添加此处/////////////////
		...
		function addMessage()
		{
			...
			if(KE.html("elem1").trim() == "")
			{
				alert("发言内容不能为空");
				return;
			}

			if(KE.html("elem1").LenDB() > 3000)
			{
			...
			cbena.content = KE.html("elem1").replace(/src=\"\.\.\/\.\.\/js\/xheditor/ig,'src="/manager/js/xheditor');
		...
		function fnQuote(index_num)
		{
			...
			KE.html("elem1",$("#"+"text_editor_"+index_num).html());
		}
		...
		function fnModify(index_num,flag,chat_id,isUpdateCatch){
			...
			KE.html("elem2",$("#"+current_sysDialog).html());
...
<body> 
	 ...
	 <tr>
	  ...
	  <td rowspan="2" valign="top">	        
	   ...
	   <div class="editor_div" >
		 ...
		 <textarea id="elem1" name="elem1" style="width:100%;height:112px"></textarea>
	...
	<div id="sysDialog" icon="icon-save" style="width:510px;height:250px;text-align:center;">
	<span class="blank3"></span>
		...
		<textarea id="elem2" name="elem2" style="width:100%;height:210px"></textarea>
		<span class="blank3"></span>
