...
var CpDeptBean = new Bean("com.cicro.wcm.bean.appeal.cpDept.CpDeptBean",true);
...
function showList(){	
	...
	table.getCol("dept_name").each(function(i){
		...
		{			
			...
			$(this).html('<a href="javascript:top.OpenModalWindow(\'修改注册机构\',\'/manager/appeal/cpDept/cpDept_add.jsp?dept_id='+beanList.get(i-1).dept_id+'\',450,190);">'+beanList.get(i-1).dept_name+'</a>');
		}
	});	
...
{
	top.OpenModalWindow("注册新机构","/manager/appeal/cpDept/cpDept_add.jsp?p_id="+dept_id,450,190);
}
...
function openUpdateCpDeptPage()
{
	...
	top.OpenModalWindow("修改注册机构","/manager/appeal/cpDept/cpDept_add.jsp?dept_id="+selectIDS,450,190);
}
