...
var CalendarBean = new Bean("com.cicro.wcm.bean.appeal.calendar.CalendarBean",true);
...
{
	top.OpenModalWindow("新建节假日信息","/manager/appeal/calendar/calendar_add.jsp?type=add",450,239);
}
function openUpdateCalendarPage(ca_id)
{
	top.OpenModalWindow("维护节假日信息","/manager/appeal/calendar/calendar_add.jsp?type=update&ca_id="+ca_id,450,239);
}
// 修改节假日信息
function updateRecord1()
{  
	var ca_id = table.getSelecteCheckboxValue("ca_id");
	top.OpenModalWindow("修改节假日信息","/manager/appeal/calendar/calendar_add.jsp?type=update&ca_id="+ca_id,450,239);
}
