...
var AreaBean = new Bean("com.cicro.wcm.bean.appeal.area.AreaBean",true);
...
{
	  top.OpenModalWindow("维护地区","/manager/appeal/area/area_add.jsp?parentID="+parent_id+"&area_id="+area_id,450,130);
}
...
{
	top.OpenModalWindow("维护地区","/manager/appeal/area/area_add.jsp?parentID="+area_id,450,130);
}
...
{     
	...
	var child_arealevel = parentbean.area_level;//父类层级
	child_arealevel +=1;//子类层级
	bean.area_level = child_arealevel;//赋值
...
function openUpdateAreaPage()
{
	var selectIDS = table.getSelecteCheckboxValue("area_id");
	  top.OpenModalWindow("维护地区","/manager/appeal/area/area_add.jsp?parentID="+area_id+"&area_id="+selectIDS,450,130);
}
...
{
	top.OpenModalWindow(title,"/manager/org/Area/select_singl_Area.jsp?handl_name="+handl_name,450,510);
}*/