...
var PurposeBean = new Bean("com.cicro.wcm.bean.appeal.purpose.PurposeBean",true);
...
{
	top.OpenModalWindow("新建诉求目的信息","/manager/appeal/purpose/purpose_add.jsp?type=add",460,145);
}

function openUpdatePurposePage2(pur_id)
{
	top.OpenModalWindow("维护诉求目的信息","/manager/appeal/purpose/purpose_add.jsp?type=update&pur_id="+pur_id,450,145);
}
//修改诉求目的信息
function updatePurposePage()
{
	var selectIDS = table.getSelecteCheckboxValue("pur_id");
	top.OpenModalWindow("维护诉求目的信息","/manager/appeal/purpose/purpose_add.jsp?type=update&pur_id="+selectIDS,450,145);
}
// 删除诉求目的信息
