...
function iniPage()
{
	$(".customLable li").click(function(){
		KE.insertHtml("ph_content", $(this).attr("title"));
	});
	if(type == "update")
	{
		fillBean();
...
function saveAdd()
{
	...
	addCommomLang.ph_content = KE.html("ph_content");
...
function saveUpdate()
{
	...
	updateCommomLang.ph_content = KE.html("ph_content");
...
{
	window.location.href  = "/manager/appeal/lang/commonLangList.jsp?ph_type="+ph_type;
}

// 输入验证常用语内容
function check_content()
{
	var str = KE.html("ph_content");
	if( KE.html("ph_content").trim() == "")
	{
