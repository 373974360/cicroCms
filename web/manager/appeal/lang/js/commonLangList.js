...
var CommonLangBean = new Bean("com.cicro.wcm.bean.appeal.lang.CommonLangBean",true);
...
function showList()
{
	...
	table.getCol("ph_title").each(function(i){	
		if(i>0)
		{
			...
			$(this).html('<a href="/manager/appeal/lang/commonLang_add.jsp?type=update&ph_id='+id+'&ph_type='+ph_type+'">'+beanList.get(i-1).ph_title+'</a>');
		}
	});
...
{
	window.location.href  = "/manager/appeal/lang/commonLang_add.jsp?type=add&ph_id=&ph_type="+ph_type;
}
...
function updateCommonLang()
{
	...
	window.location.href  = "/manager/appeal/lang/commonLang_add.jsp?type=update&ph_id="+id+"&ph_type="+ph_type;
}
