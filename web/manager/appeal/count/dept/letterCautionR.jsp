...
<%
   ...
   List<CountBean> list = CountServices.getCountDeptCaution(s,e,b_ids);
   pageContext.setAttribute("list",list);
   
   String[] head = {"处理部门","总件数","超期件","预警件","黄牌件","红牌件","督办件","延期件"};
...
<script type="text/javascript">	
		...
		$(document).ready(function () {	
			var beanList = CountServicesRPC.getListAllCaution('${s}','${e}','${b_ids}');	
