...
<%@ page import="com.cicro.wcm.bean.appeal.count.CountBean" %>
<%@page import="com.cicro.util.jconfig.*"%>
<%@page import="com.cicro.util.FormatUtil"%>
<%@page import="com.cicro.wcm.services.appeal.count.CountUtil"%>
<%@page import="java.io.File"%>
<%@page import="com.cicro.wcm.services.appeal.count.OutExcel"%>
<%@page import="com.cicro.wcm.services.appeal.count.CountServices"%>
...
<%
   ...
   pageContext.setAttribute("b_ids",b_ids);
	...
	String urlFile = "/manager/appeal/count/dept/"+nowDate+File.separator+xls;
	 

   List<Object[]> list = CountServices.getCountRecordDept(s,e,b_ids);
   pageContext.setAttribute("list",list);  
   
   //得到满意度列表
   List<Map>  listSatisfaction =com.cicro.wcm.services.appeal.count.CountServicesUtil.getSatisfactionList();
...
<script type="text/javascript" src="/manager/js/jquery-ui/jquery-ui.js"></script>
...
<script type="text/javascript">	
		...
		$(document).ready(function () {	 
			var beanList = CountServicesRPC.getListAllSatisfactionDept('${s}','${e}','${b_ids}');	
