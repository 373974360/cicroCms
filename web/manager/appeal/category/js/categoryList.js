...
var CategoryBean = new Bean("com.cicro.wcm.bean.appeal.category.CategoryBean",true);
...
{
	top.OpenModalWindow("维护分类信息","/manager/appeal/category/category_add.jsp?cat_id="+cat_id,450,140);
}
...
{
	top.OpenModalWindow("维护分类","/manager/appeal/category/category_add.jsp?parentID="+cat_id,450,140);
}

function openUpdateCategoryPage()
{
	var selectIDS = table.getSelecteCheckboxValue("cat_id");
	top.OpenModalWindow("维护分类","/manager/appeal/category/category_add.jsp?parentID="+cat_id+"&cat_id="+selectIDS,450,140);
}
//添加内容分类
