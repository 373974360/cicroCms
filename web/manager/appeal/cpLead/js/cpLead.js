...
var CpLeadBean = new Bean("com.cicro.wcm.bean.appeal.cpLead.CpLeadBean",true);
...
function showList(){
	...
	table.getCol("lead_name").each(function(i){
		...
		{			
			...
			$(this).html('<a href="/manager/appeal/cpLead/cpLead_add.jsp?lead_id='+beanList.get(i-1).lead_id+'" target="_self" >'+beanList.get(i-1).lead_name+'</a>');
		}
	});	
...
function addCpLead()
{
	...
	if(CpLeadRPC.insertCpLead(bean))
	{
		...
		window.location.href = "/manager/appeal/cpLead/cpLeadList.jsp";
