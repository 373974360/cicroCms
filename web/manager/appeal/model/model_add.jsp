...
{
	top.OpenModalWindow(title,"/manager/appeal/cpDept/select_dept.jsp?handl_name="+handl_name,450,510);
}

//打开选择领导人窗口
function openSelectCPLead(title,handl_name)
{
	top.OpenModalWindow(title,"/manager/appeal/cpLead/select_lead.jsp?handl_name="+handl_name,450,510);
}
