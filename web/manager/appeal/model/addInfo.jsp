...
<script language="javascript" src="/wcm.files/js/jquery-plugin/jquery.uploadify.js"></script>
<script language="javascript" src="/wcm.files/js/jquery-plugin/uploadFile/swfobject.js"></script>
<script charset="utf-8" src="../../js/kindeditor/kindeditor.js"></script>
<script type="text/javascript" src="../../js/jquery-easyui/jquery.easyui.min.js"></script>
<script type="text/javascript" src="../../js/indexjs/tools.js"></script>
<script type="text/javascript" src="/wcm.files/js/appeal.js"></script>
...
var SQAttachment = new Bean("com.cicro.wcm.bean.appeal.sq.SQAttachment",true);
var local_IP ="";
...
function SubmitLetterInfo()
{
	...
	var pur_id = $(":radio[id='pur_id'][checked=true]").val();
	if(pur_id == ""){
       SQBean.pur_id = "0";
	}else{
	...
	SQBean.sq_sex = $(":radio[id='sq_sex'][checked=true]").val()+"";
	if($("#sq_age").val() == ""){
		SQBean.sq_age = 0;
	}else{
	...
	if(SQRPC.insertSQ(SQBean,SQAttBean))
	{
	    ...
	    */
		top.msgAlert("操作成功!");
		window.location.href = "/manager/appeal/model/modelList.jsp";
	}else
	{
		top.msgWargin("操作失败!");
	}
