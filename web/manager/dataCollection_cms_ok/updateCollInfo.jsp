...
var articleInfoBean = new Bean("com.cicro.wcm.dataCollection.bean.ArticleInfoBean",true);
var infoid = "<%=info_id%>"; 
var tab_index = "${param.tab_index}";
var contetnid = "art_content";
var site_id = "<%=site_id%>";
var defaultBean;
  ...
  <table id="collinfo_article_table" class="table_form" border="0" cellpadding="0" cellspacing="0">
	<tbody>
		...
		<tr>
			...
			<td style="">
				<textarea id="art_content" name="art_content" style="width:620px;;height:300px;visibility:hidden;"></textarea>
