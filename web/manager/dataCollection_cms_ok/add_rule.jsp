...
$(document).ready(function(){
	...
	init_input();
	init_FromTabsStyle();
	showSelectDiv("cat_name","cat_tree_div",300);
	showCategoryTree(); //加载栏目树
	emptyCatgroyInput();
...
//			$("#stop_time").val(defaultBean.stop_time);
			...
			$("#cat_name").val(defaultBean.cat_name);
...
<table class="table_form" id="collRuleTab">
 	<tr>
		...
		<th style="width:10%"><span style="color: red">*</span>入库信息:</th>
		<td style="width:70%">
			<table style="margin:7px;">
				<tr>
					<td style="width:15%">
						<div class="infoListTable" id="catlistTable">
							<div id="a11">
								<input type="text" id="cat_name" value="--请选择栏目--" style="width:176px; height:18px; overflow:hidden;" readonly="readonly"/>
								<input type="hidden" id="catidhidden" name="catidhidden" value="" />
					...
					<th style="text-align:left">--请选择末级栏目--</th>
				</tr>
			</table>
		</td>
 	</tr>
