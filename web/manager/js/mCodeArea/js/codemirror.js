...
var CodeMirror = (function(){
  ...
  setDefaults(CodeMirrorConfig, {
    ...
    path: "",
    parserfile: [],
    basefiles: ["/manager/js/mCodeArea/js/util.js", "/manager/js/mCodeArea/js/stringstream.js", "/manager/js/mCodeArea/js/select.js", "/manager/js/mCodeArea/js/undo.js", "/manager/js/mCodeArea/js/editor.js", "/manager/js/mCodeArea/js/tokenize.js"],
...
function mCodeIconMouse()
{
	$(".code_icon").hover(
	  function () {
		$(this).css("border","1px solid #0A246A").css("background","#B6BDD2");
	  },
	  function () {
		$(this).css("border","0px").css("background","none");;
	  }
	);
}

function mCodeIconEvent(cmd)
{
	switch(cmd){			
		case "creaList":						
			top.OpenModalWindow("列表生成工具","/manager/system/template/list_tools.jsp",650,420);
			return false;
		case "hotList":						
			top.OpenModalWindow("热点信息生成工具","/manager/system/template/hotlist_tools.jsp",650,440);
			return false;
		case "creaLink":						
			top.OpenModalWindow("获取链接地址","/manager/system/template/link_tools.jsp",650,495);
			return false;
		case "selImg":						
			top.OpenModalWindow("选择图片","/manager/system/template/select_file.jsp",650,495);
			return false;
	}
}