...
{
	MateInfoBean = new Bean("com.cicro.wcm.bean.material.MateInfoBean",true)
...
function initTemplateUpLoad()
{
	var sizeLimit = 104857600;
	 ...
	 $("#uploadify").uploadify( {//初始化函数
		'uploader' :'/manager/js/uploadFile/uploadify.swf',//flash文件位置，注意路径
		//'script' :jsonrpc.SiteRPC.getDefaultSiteDomainBySiteID(site_id)+'/manager/servlet/TemplateResourcesUpload',//后台处理的请求
		'script' :'/manager/servlet/TemplateResourcesUpload',//后台处理的请求
		'cancelImg' :'/manager/js/uploadFile/cancel.png',//取消按钮图片
		'buttonImg': '/manager/js/uploadFile/upst.gif',
