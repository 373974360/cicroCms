var bean = new Bean("com.cicro.project.searchkeys.SearchCustomKey",true);
...
function initTable(){
	...
	colsList.add(setTitleClos("countnum","搜索次数","100px","","",""));
...
function addData(){
	...
	var DateBean = BeanUtil.getCopy(DateBean);
