...
<%@page import="com.cicro.util.FormatUtil,com.cicro.project.weinanzjzf.*,com.cicro.util.OutExcel,com.cicro.util.jconfig.JconfigUtilContainer,com.cicro.wcm.services.appeal.count.CountUtil,java.io.File"%>
<%
...
//删除今天以前的文件夹  并 创建今天的文件夹和xls文件
	public static String[] getFileUrl(){
		...
		String path = FormatUtil.formatPath(root_path + "/project/wnbxwz/export");  
		...
		String urlFile = "/manager/project/wnbxwz/export/"+nowDate+File.separator+xls;
