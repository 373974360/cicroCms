...
var ErrorSiteBean = new Bean("com.cicro.project.dz_siteError.ErrorSiteBean", true);
...
function initTable() {
    ...
    colsList.add(setTitleClos("siteType", "网站分类", "170px", "", "", ""));
...
function openUpdateErrorSitePage(id) {
    ...
    top.OpenModalWindow("纠错站点", "/manager/project/dz_siteError/viewErrorSite.jsp?id=" + c_id +"&topnum="+top.curTabIndex, 385, 250);
...
function addInfo() {
    top.OpenModalWindow("纠错站点", "/manager/project/dz_siteError/viewErrorSite.jsp?topnum="+top.curTabIndex, 385, 250);
}