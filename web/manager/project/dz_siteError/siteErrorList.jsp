            ...
            <td align="left" width="" colspan="3">
                <ul class="fromTabs">
                    <li class="list_tab list_tab_cur">
                        <div class="tab_left">
                            <div class="tab_right">未处理，未发布</div>
                        </div>
                    </li>
                    <li class="list_tab">
                        <div class="tab_left">
                            <div class="tab_right">处理中，已发布</div>
                        </div>
                    </li>
					<li class="list_tab">
                        <div class="tab_left">
                            <div class="tab_right">已处理，已发布</div>
                        </div>
                    </li>
                </ul>
            </td>
    ...
    <table class="table_option" border="0" cellpadding="0" cellspacing="0">
        <tr>
            <td align="left" valign="middle">
				...
				<input id="btnHandle" type="button" class="btn x2" value="处理中已发布" onclick="updateRecord(table,'id','savePublishFlag(1)');"/>
				<input id="btnHandle" type="button" class="btn x2" value="已处理已发布" onclick="updateRecord(table,'id','savePublishFlag(2)');"/>
