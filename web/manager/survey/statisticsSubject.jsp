...
<SCRIPT LANGUAGE="JavaScript">
	<!--
		...
		function openTextDetailWindow(item_ids,item_nums,s_type)
		{
			...
			top.OpenModalWindow("查看详细信息","/manager/survey/view_itemDetail.jsp?item_id="+item_ids+"&item_num="+item_nums+"&s_id="+s_id+"&s_type="+s_type,800,490);	
		}
		...
		function openSearch()
		{
			...
			top.OpenModalWindow("数据统计查询","/manager/survey/search_statistics.jsp?s_id="+s_id,800,490);
		}
	//-->
	</SCRIPT>
</head>
