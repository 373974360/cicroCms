...
function fnAddSurveyCategory()
{
	...
	//top.OpenModalWindow("维护问卷分类","/manager/survey/add_surveyCategory.jsp",440,305);	
}
...
{
	//top.OpenModalWindow("维护问卷分类","/manager/survey/add_surveyCategory.jsp?c_id="+c_id,440,305);
	window.location.href = "/manager/survey/add_surveyCategory.jsp?c_id="+c_id+"&site_id="+site_id;
}

function fnUpdateSurveyCategory()
{
	var selectIDS = table.getSelecteCheckboxValue("category_id");	
	//top.OpenModalWindow("维护问卷分类","/manager/survey/add_surveyCategory.jsp?c_id="+selectIDS,440,305);
	window.location.href = "/manager/survey/add_surveyCategory.jsp?c_id="+selectIDS+"&site_id="+site_id;
}
/**********************修改操作　结束*************************************/
