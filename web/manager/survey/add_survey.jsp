...
<div class="blankH9"></div>
 <table id="" border="0" cellpadding="0" cellspacing="0" width="98%" align="center" >
	<tr><td><textarea id="contents" name="contents" style="width:98%;height:360px"></textarea></td></tr>
  <!-- <tr>
