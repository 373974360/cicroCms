...
function showManagerList(){
	...
	manager_table.getCol("user_realname").each(function(i){
		if(i>0)
		{
			$(this).html('<a href="javascript:top.addTab(true,\'/manager/org/dept/user_view.jsp?user_id='+manager_beanList.get(i-1).user_id+'\',\'用户信息\')">'+manager_beanList.get(i-1).user_realname+'</a>');
		}
	});
...
{	
	...
	//top.OpenModalWindow("维护部门管理员","/manager/org/dept/deptMan_add.jsp?dept_id="+selected_dept_id,610,510);
