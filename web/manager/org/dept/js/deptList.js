...
var DeptBean = new Bean("com.cicro.wcm.bean.org.dept.DeptBean",true);
...
function showDeptList(){
	...
	table.getCol("dept_name").each(function(i){	
		if(i>0)
		{
			$(this).html('<a href="javascript:top.addTab(true,\'/manager/org/dept/dept_view.jsp?dept_id='+beanList.get(i-1).dept_id+'\',\'部门信息\')">'+beanList.get(i-1).dept_name+'</a>');	
		}
	});
