...
<table class="table_option" border="0" cellpadding="0" cellspacing="0">
		<tr>
			<td align="left" valign="middle">
				...
				<input id="btn3" name="btn3" type="button" onclick="publicSelectCheckbox(user_table,'user_id','openSelectSingleDept(\'选择组织机构节点\',\'moveUser\',\'\')')" value="移动用户" /><!-- openSelectSingleDept 函数在/manager/js/sysUI.js中 -->
				...
				<input id="btn1" name="btn1" type="button" onclick="deleteRecord(user_table,'user_id','deleteUser()');" value="删除" /><!-- deleteRecord 函数在/manager/js/sysUI.js中 -->
			</td>
		</tr>
	</table>
</div>
	...
	<table class="table_option" border="0" cellpadding="0" cellspacing="0">
		<tr>
			<td align="left" valign="middle">
				...
				<input id="btn3" name="btn3" type="button" onclick="publicSelectCheckbox(table,'dept_id','openSelectSingleDept(\'选择组织机构节点\',\'moveDept\',\'\')')" value="移动部门" /><!-- openSelectSingleDept 函数在/manager/js/sysUI.js中 -->				
				<input id="btn2" name="btn2" type="button" onclick="saveDeptSort();" value="保存排序" />
				<input id="btn3" name="btn3" type="button" onclick="deleteRecord(table,'dept_id','deleteDeptHandl()');" value="删除" /><!-- deleteRecord 函数在/manager/js/sysUI.js中 -->
			</td>
		</tr>
	</table>
</div>
	...
	<table class="table_option" border="0" cellpadding="0" cellspacing="0">
		<tr>
			<td align="left" valign="middle">
				...
				<input id="btn3" name="btn3" type="button" onclick="deleteRecord(manager_table,'user_id','deleteDeptManager()');" value="删除" /><!-- deleteRecord 函数在/manager/js/sysUI.js中 -->
			</td>
		</tr>
	</table>
</div>
