...
<script type="text/javascript" src="js/userList.js?v=20150721"></script>
...
$(document).ready(function(){
	...
	if(user_id != "" && user_id != "null" && user_id != null)
	{
		...
		if(defaultBean)
		{
			...
			KE.html("resume",defaultBean.resume);
			KE.html("summary",defaultBean.summary);
...
<table class="table_form" border="0" cellpadding="0" cellspacing="0">
	<tbody>
		<tr>
			...
			<td colspan="3">
				<textarea id="resume" name="resume" style="width:585px;;height:180px;"></textarea>		
			</td>
		</tr>
		<tr>
			<th style="vertical-align:top;">个人简介：</th>
			<td colspan="3">
				<textarea id="summary" name="summary" style="width:585px;;height:180px;"></textarea>		
			</td>
		</tr>
		<tr>
			<th style="vertical-align:top;">备注：</th>
			<td colspan="3">
				<textarea id="user_memo" name="user_memo" style="width:585px;;height:100px;" onblur="checkInputValue('user_memo',true,1000,'备注','')"></textarea>		
			</td>
		</tr>
		<tr>
			<th>用户状态：</th>
