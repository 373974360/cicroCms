...
var SiteUserBean = new Bean("com.cicro.wcm.bean.org.siteuser.SiteUserBean",true);
...
function showList()
{
	...
	table.getCol("user_name").each(function(i){
		if(i>0)
		{
			...
			$(this).html('<a href="javascript:top.addTab(true,\'/manager/org/dept/user_view.jsp?user_id='+beanList.get(i-1).user_id+'\',\'用户信息\')">'+name+'</a>');	
		}
	});
