...
{
	top.OpenModalWindow("查看菜单信息","/manager/org/operate/menu_view.jsp?menu_id="+m_id,500,300);
}
...
{
	top.OpenModalWindow("维护菜单","/manager/org/operate/menu_add.jsp?parentID="+menu_id,500,300);
}
...
function openUpdateMenuPage()
{
	...
	top.OpenModalWindow("维护菜单","/manager/org/operate/menu_add.jsp?parentID="+menu_id+"&menu_id="+selectIDS,500,300);
}
...
{
	top.OpenModalWindow(title,"/manager/org/operate/select_menu.jsp?handl_name="+handl_name,610,510);
}