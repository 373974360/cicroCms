...
var OperateBean = new Bean("com.cicro.wcm.bean.org.operate.OperateBean",true);
...
{
	top.OpenModalWindow("查看权限信息","/manager/org/operate/operate_view.jsp?opt_id="+o_id,500,308);
}
...
{
	top.OpenModalWindow("维护权限","/manager/org/operate/operate_add.jsp?parentID="+opt_id,500,308);
}

function openUpdateOperatePage()
{
	var selectIDS = table.getSelecteCheckboxValue("opt_id");
	top.OpenModalWindow("维护权限","/manager/org/operate/operate_add.jsp?parentID="+opt_id+"&opt_id="+selectIDS,500,308);
}
...
{
	top.OpenModalWindow(title,"/manager/org/operate/select_singl_operate.jsp?handl_name="+handl_name,450,510);
}