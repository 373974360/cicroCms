...
var DeptLevelBean = new Bean("com.cicro.wcm.bean.org.dept.DeptLevelBean",true);
...
function showList()
{
	...
	table.getCol("deptlevel_name").each(function(i){
		if(i>0)
		{
			$(this).html('<a href="javascript:top.OpenModalWindow(\'部门级别信息\',\'/manager/org/deptLevel/deptLevel_view.jsp?deptlevel_id='+beanList.get(i-1).deptlevel_id +'\',450,245)">'+beanList.get(i-1).deptlevel_name+'</a>');	
		}
	});
...
{
	top.OpenModalWindow("新建部门级别","/manager/org/deptLevel/deptLevel_add.jsp?type=add&deptlevel_id=",460,245);
}
...
function updateLevel()
{
	...
	top.OpenModalWindow("修改部门级别","/manager/org/deptLevel/deptLevel_add.jsp?type=update&deptlevel_id="+deptlevel_id,430,260);
}
