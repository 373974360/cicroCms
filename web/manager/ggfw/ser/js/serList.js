...
var SerCategoryBean = new Bean("com.cicro.wcm.bean.zwgk.ser.SerCategoryBean",true);
...
{
	top.addTab(true,"/manager/cms/info/article/articleDataList.jsp?cat_id="+xgwt_cat_id+"&app_id=ggfw&site_id=ggfw","相关信息维护");
}

function openCJWTPage(cjwt_cat_id)
{
	top.addTab(true,"/manager/cms/info/article/articleDataList.jsp?cat_id="+cjwt_cat_id+"&app_id=ggfw&site_id=ggfw","常见问题维护");
}
...
{
	if(ser_id != null)
		top.addTab(true,"/manager/ggfw/ser/serTopic_add.jsp?top_index="+top.curTabIndex+"&ser_id="+ser_id,"维护场景主题");
	else
		top.addTab(true,"/manager/ggfw/ser/serTopic_add.jsp?top_index="+top.curTabIndex,"维护场景主题");
}
