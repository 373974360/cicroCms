...
{
	if(s_id != null)
		top.addTab(true,"/manager/ggfw/ser/serCate_add.jsp?parent_id="+ser_id+"&top_index="+top.curTabIndex+"&s_id="+s_id,"维护场景导航");
	else
		top.addTab(true,"/manager/ggfw/ser/serCate_add.jsp?parent_id="+ser_id+"&top_index="+top.curTabIndex,"维护场景导航");
}
...
{
	top.OpenModalWindow("选择信息","/manager/cms/info/article/selectInfo.jsp?top_index="+top.curTabIndex+"&app_id="+app_id,800,530);
}
