...
<link rel="stylesheet" type="text/css" href="js/jquery-ui/themes/base/jquery.ui.all.css"  />
	...
	<script type="text/javascript" src="js/indexjs/tools.js?v=20151015"></script>	
	...
	<table border="0" cellpadding="0" cellspacing="0" class="banaerContent">
		<tr>
			<td align="left" valign="top">
				<div class="left textLeft" style="500px;height:82px;overflow:hidden;">
					<span class="blank12"></span>
					<!--<div class="left" style="width:30px;">&nbsp;</div>-->
					<div class="left" style="width:250px;height:62px;overflow:hidden">
						<div id="sysname">政务信息管理平台</div>
                    	
					</div>
					<!--<div class="left" style="width:8px;">&nbsp;</div>-->
					<div class="left" style="height:70px;overflow:hidden;">
					<!--  -->
					<ul id="top_menu">
...
<!--页尾版权区域开始-->
<div id="copyright">
	Copyright © 2002-2014 Dyt Technology Co., Ltd.. All rights reserved
</div>
<!--页尾版权区域结束-->
