...
<tr>
	...
	<td  align="left"><input  tabindex="1" id="username" name="username" type="text" class="loginInput" maxlength="20" value="" /> </td>
	
</tr>
<tr> 
	<th>密　码：</th>
	<td><input  tabindex="2" id="password" name="password" type="password" class="loginInput"  maxlength="20" value="" /></td>

</tr>
<tr>
	<th>验证码：</th>
	<td>
		<input   tabindex="3" id="auth_code" name="auth_code" type="text" class="loginInput" style="width:52px;" maxlength="6" value="" />
