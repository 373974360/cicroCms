...
{
	top.addTab(true,"/manager/comment/commentList.jsp?info_type="+info_type+"&"+param,"评论管理");
}
...
{
	top.addTab(true,"/manager/appCom/guestbook/reply_gb.jsp?site_id="+site_id+"&topnum="+top.curTabIndex+"&id="+id+"&gbs_id="+gbs_id+"&cat_id="+cat_id,"编辑留言");
}
...
{
	top.addTab(true,"/manager/appCom/guestbook/view_gb.jsp?site_id="+site_id+"&topnum="+top.curTabIndex+"&id="+id+"&gbs_id="+gbs_id+"&cat_id="+cat_id,"查看留言");
}
