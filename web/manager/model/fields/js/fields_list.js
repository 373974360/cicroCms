...
{  
	...
	top.addTab(true,'/manager/model/fields/fields_add.jsp?tab_index='+top.curTabIndex,'添加元数据');
}
...
{    
	//top.OpenModalWindow("维护站点","/manager/control/site/site_add.jsp?parentID="+site_id,500,360);
	//alert('/manager/member2/onlinebook/bookList_add.jsp?parentID='+site_id+"&tab_index="+top.curTabIndex);
	top.addTab(true,'/manager/model/fields/fields_add.jsp?tab_index='+top.curTabIndex+"&id="+id+"&type=mod",'修改元数据');
}
