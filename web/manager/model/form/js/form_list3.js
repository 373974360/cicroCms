var Fields = new Bean("com.cicro.wcm.services.model.Fields",true);
...
function openFieldsListPage(){
   // alert(ids);
	top.OpenModalWindow("选择元数据","/manager/model/fields/fields_list_select.jsp?model_id="+model_id+"&ids="+ids,1000,600);
}
...
{    
	...
	//alert('/manager/member2/onlinebook/bookList_add.jsp?parentID='+site_id+"&tab_index="+top.curTabIndex);
	top.addTab(true,'/manager/model/form/form_fields_add.jsp?tab_index='+top.curTabIndex+"&id="+id+"&type=mod",'修改字段');
}
