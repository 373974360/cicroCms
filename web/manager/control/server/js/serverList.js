...
var SiteServerBean = new Bean("com.cicro.wcm.bean.control.SiteServerBean",true);
...
function initTable(){
	...
	colsList.add(setTitleClos("server_ip","RMIIP","160px","","",""));
    colsList.add(setTitleClos("server_port","RMI端口","160px","","",""));
...
function openAddPage(){ 
	top.OpenModalWindow("维护服务器","/manager/control/server/server_add.jsp",500,300);
}
...
function openUpdatePage(){
	...
	top.OpenModalWindow("维护服务器","/manager/control/server/server_add.jsp?server_id="+selectIDS,500,300);
}

//打开查看页面
function openViewPage(s_id)
{  
	top.OpenModalWindow("查看服务器信息","/manager/control/server/server_view.jsp?server_id="+s_id,500,300);
}
