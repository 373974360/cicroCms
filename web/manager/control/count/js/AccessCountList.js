var InfoAccessBean = new Bean("com.cicro.wcm.bean.cms.count.InfoAccessBean",true);
...
function openAccessInfos(site_id,site_name) { 
	top.OpenModalWindow("查看 "+site_name+" 详细信息","/manager/control/count/cmsSiteCateInfoAccess.jsp?site_id="+site_id,1000,600);
