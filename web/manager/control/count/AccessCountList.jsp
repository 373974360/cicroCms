...
function openSelectPage(){
	top.OpenModalWindow("选择站点","/manager/control/count/siteSelect.jsp",318,480);
}
</script>
</head>
<body>
<table style="width:100%" border="0" cellpadding="0" cellspacing="0" >
    ...
    <tr>
        ...
        <div style="float:left">
        	<input id="all_cat_ids" type="checkbox" class="checkBox_mid" onclick="allSelected()"/>全部
