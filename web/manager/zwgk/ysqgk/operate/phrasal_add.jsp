...
function iniAddPage()
{
	$(".customLable li").click(function(){
		KE.insertHtml("gph_content", $(this).attr("title"));
	});
}
...
<table id="Phrasal_table" class="table_form" border="0" cellpadding="0" cellspacing="0">
	<tbody>
		...
		<tr>
			...
			<td>
				<textarea id="gph_content" name="gph_content" style="width:620px;height:205px;visibility:hidden;"></textarea>
			</td>
		</tr>
	</tbody>
</table>
