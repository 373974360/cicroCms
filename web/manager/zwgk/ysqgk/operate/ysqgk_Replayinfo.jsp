...
function check_do_state(do_state){	
   ...
   {
	  $("#publish_stateTD").html("是");
   }else{
	  $("#publish_stateTD").html("否");
   }
...
{
	window.open("http://www.weinan.gov.cn/info/iList.jsp?tm_id=2890&ysq_id="+ysq_id);
}
		...
		<tbody>          
           ...
           <tr>
            ...
            <tr>
				...
				<td>
				  <ul id="a123">
					<li><input id="is_derate" name="is_derate" type="radio" value="0"/><label for="e">否</label></li>
					<li><input id="is_derate" name="is_derate" type="radio" value="1" checked="true"/><label for="f">是</label></li>
				  </ul>
				</td>				
			</tr>			
			<tr>
			...
			<tr id="is_mail_tr">
				...
				<td>
					<ul id="a123">
                        ...
                        <li><input id="is_mail" name="is_mail" type="radio" value="1" /><label for="e">是</label>
                        </li>
					</ul>
				</td>
			</tr>
