...
var YsqgkPhrasalBean = new Bean("com.cicro.wcm.bean.zwgk.ysqgk.YsqgkPhrasalBean",true);
...
{
	window.location.href  = "/manager/zwgk/ysqgk/operate/phrasal_add.jsp?type=add&gph_type="+gph_type;
}
function openPhrasaPage2(gph_id)
{
	window.location.href  = "/manager/zwgk/ysqgk/operate/phrasal_add.jsp?type=update&gph_id="+gph_id+"&ggph_type="+gph_type;
}
// 修改常用语信息
...
function addPhrasal()
{
	...
	addBean.gph_content = KE.html("gph_content");
...
function updatePhrasal(gph_type)
{
	...
	if(YsqgkRPC.updateYsqgkPhrasalBean(updateBean))
	{
		...
		//goBack();
		window.location.href  = "/manager/zwgk/ysqgk/operate/ysqgk_phrasal.jsp?gph_type="+gph_type;
	}
	else
	{
