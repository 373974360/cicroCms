...
var GKNodeCategory = new Bean("com.cicro.wcm.bean.zwgk.node.GKNodeCategory",true);
...
{
	top.OpenModalWindow("维护公开节点分类","/manager/zwgk/node/gkCate_add.jsp",450,135);
}
...
function openUpdateCatePage(nc_id)
{
	...
	top.OpenModalWindow("维护公开节点分类","/manager/zwgk/node/gkCate_add.jsp?nodcat_id="+selectIDS,450,135);
}
