...
var GKNodeBean = new Bean("com.cicro.wcm.bean.zwgk.node.GKNodeBean",true);
...
{	
	top.addTab(true,"/manager/cms/category/categoryList.jsp?cat_type=0&app_id="+app_id+"&site_id="+node_id,"维护公开节点目录");
}
...
{
	top.addTab(true,"/manager/zwgk/node/gkNode_add.jsp?top_index="+top.curTabIndex+"&nodcat_id="+nodcat_id,"维护公开节点");
}
...
function openUpdateNodePage(nc_id)
{
	...
	top.addTab(true,"/manager/zwgk/node/gkNode_add.jsp?top_index="+top.curTabIndex+"&node_id="+selectIDS,"维护公开节点");
}
