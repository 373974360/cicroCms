...
<%@page import="com.cicro.wcm.services.zwgk.export.ExportInfoRPC"%>
<%@page import="java.util.*"%>
<%@page import="com.cicro.wcm.bean.zwgk.export.*"%>
<%@page import="com.cicro.util.DateUtil"%>
<%@page import="com.cicro.util.Encode"%>
<%@page import="com.cicro.wcm.services.zwgk.appcatalog.RegulationManager"%>
<%
