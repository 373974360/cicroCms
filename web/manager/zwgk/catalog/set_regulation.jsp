...
var RegulationBean = new Bean("com.cicro.wcm.bean.zwgk.appcatalog.RegulationBean",true);
var node_json_data = "";
...
function choose_regu()
{
	...
	if(choose_type == "zwgk")
	{
		...
		node_ids = $('#leftMenuTree').tree('getSelected').attributes.t_node_id;
...
function getLeafTreeNode(div_name){
	...
	$('#'+div_name+' span.tree-file+span.tree-checkbox1').each(function(i){
		...
		if(div_name == "leftMenuTree2" && choose_type != "zwgk")
		{
