...
var PageBean = new Bean("com.cicro.wcm.bean.page.PageBean",true);
var val=new Validator();

function openAddPage(parent_id)
{	
	top.addTab(true,"/manager/page/page_add.jsp?parent_id="+parent_id+"&app_id="+app_id+"&site_id="+site_id+"&cur_indexid="+top.curTabIndex,'维护页面');
}

function openUpdatePage(id)
{	
	top.addTab(true,"/manager/page/page_add.jsp?id="+id+"&cur_indexid="+top.curTabIndex,'维护页面');
}
