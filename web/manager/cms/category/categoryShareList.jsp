...
{
	top.addTab(true,"/manager/cms/category/category_share_add.jsp?top_index="+top.curTabIndex+"&class_id="+class_id+"&parentID="+cat_id,"维护目录");
}

function viewCategory(c_id)
{
	top.addTab(true,'/manager/cms/category/category_share_view.jsp?cat_id='+c_id,'查看目录');
}
</script>
</head>
