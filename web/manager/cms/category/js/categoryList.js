...
var CategorySharedBean = new Bean("com.cicro.wcm.bean.cms.category.CategorySharedBean",true);
var SyncBean = new Bean("com.cicro.wcm.bean.cms.category.SyncBean",true);
var CategoryReleBean = new Bean("com.cicro.wcm.bean.cms.category.CategoryReleBean",true);
var CategoryModel = new Bean("com.cicro.wcm.bean.cms.category.CategoryModel",true);
...
{
	top.addTab(true,"/manager/cms/category/category_add.jsp?top_index="+top.curTabIndex+"&site_id="+site_id+"&app_id="+app_id+"&class_id="+class_id+"&parentID="+cat_id,"维护目录");
}
...
function openUpdateCategoryPage(cid)
{
	...
	if(cate_type == "share")
		top.addTab(true,"/manager/cms/category/category_share_add.jsp?app_id="+app_id+"&site_id="+site_id+"&class_id="+class_id+"&top_index="+top.curTabIndex+"&id="+id,"维护目录");
	else
		top.addTab(true,"/manager/cms/category/category_add.jsp?app_id="+app_id+"&site_id="+site_id+"&class_id="+class_id+"&top_index="+top.curTabIndex+"&id="+id,"维护目录");
}
...
{
	top.OpenModalWindow(title,"/manager/cms/category/select_menu.jsp?handl_name="+handl_name,610,510);
}
...
function setModelInfoListHandl(list,temp_site_id,flag)
{
	...
	if(list != null && list.size()> 0)
	{
		for(var i=0;i<list.size();i++)
		{
			...
			str += '<tr>';
			str += '<td align="center"><input type="checkbox" id="model_id" name="model_id" value="'+list.get(i).model_id+'" '+checked+'></td>';
