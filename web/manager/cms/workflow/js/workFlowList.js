...
var WorkFlowBean = new Bean("com.cicro.wcm.bean.cms.workflow.WorkFlowBean",true);
var WorkFlowStepBean = new Bean("com.cicro.wcm.bean.cms.workflow.WorkFlowStepBean",true);
...
{	
	window.location.href = "/manager/cms/workflow/workFlow_view.jsp?wf_id="+r_id;
}

//打开添加窗口
function openAddWorkFlowPage()
{
	window.location.href = "/manager/cms/workflow/workFlow_add.jsp?app_id="+app_id;
}
...
function openUpdateWorkFlowPage(wf_id)
{
	...
	if(wf_id == null || wf_id == "")
		...
		selectIDS = wf_id;
	window.location.href = "/manager/cms/workflow/workFlow_add.jsp?wf_id="+selectIDS+"&app_id="+app_id;
}
