...
{
	top.addTab(true,"/manager/cms/info/article/m_gk_gkzn.jsp?info_id="+info_id+"&cid="+cat_id+"&site_id="+site_ids+"&app_id="+app+"&topnum="+top.curTabIndex,"维护信息");	
}
...
function openViewPage(i_id,site_ids)
{
	...
	top.addTab(true,"/manager/cms/info/article/infoView.jsp?info_id="+i_id+"&site_id="+site_ids+"&topnum="+top.curTabIndex,"查看信息");
}
