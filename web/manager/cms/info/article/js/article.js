...
{	//OpenModalWindow
	top.OpenModalWindow("选择相关信息","/manager/cms/info/article/chooseInfoPage.jsp?info_id="+Info_id+"&site_id="+site_id,825,500);	
}
...
{	//OpenModalWindow
	...
	top.OpenModalWindow("选择相关信息","/manager/cms/info/article/focusInfo.jsp?info_id="+Info_id+"&site_id="+site_id+"&t="+tmp,660,500);	
}

//打开添加窗口
function openAddInfoPage()
{
	window.location.href = "/manager/cms/info/article/infoAdd.jsp?cid="+cid+"&site_id="+site_id;
}

function openAddInfoPage1()
{
	window.location.href = "/manager/cms/info/article/articleAdd.jsp?cid="+cid+"&app="+app+"&site_id="+site_id;
}
...
{
	window.location.href = "/manager/cms/info/article/infoAdd.jsp?cid="+cid+"&info_id="+Infoid+"&site_id="+site_id;
}

function openUpdatePage2(Infoid)
{
	top.OpenModalWindow("修改信息","/manager/cms/info/article/infoAdd2.jsp?cid="+cid+"&info_id="+Infoid+"&site_id="+site_id,620,220);	
}
...
function addInfoData()
{
	...
	if(ArticleRPC.addArticle(bean))
	{
		...
		window.location.href = "/manager/cms/info/article/articleDataList.jsp?cat_id="+cid+"&app="+bean.app_id+"&site_id="+bean.site_id;
	}
	else
	{
...
function updateInfoData()
{
	...
	if(ArticleRPC.updateArticle(bean))
	{
		...
		top.msgAlert("信息"+WCMLang.Add_success);			
		window.location.href = "/manager/cms/info/article/articleDataList.jsp?cat_id="+bean.cat_id+"&app="+bean.app_id+"&site_id="+bean.site_id;
	}
	else
	{
		top.msgAlert("信息"+WCMLang.Add_fail);
