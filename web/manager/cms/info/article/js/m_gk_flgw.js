var GKFflgwBean = new Bean("com.cicro.wcm.bean.cms.info.GKFflgwBean",true);
...
{	
	...
	var bean = BeanUtil.getCopy(GKFflgwBean);	
	...
	publicSaveInfoEvent(bean,"gkfflgw","insert");
...
function updateInfoData()
{
	...
	publicSaveInfoEvent(bean,"gkfflgw","update");
}