...
function OpenWindowForSubmit(){
	...
	var isPublish = $("#isPublish").attr("checked");
	...
	top.OpenModalWindow("信息高级获取","/manager/cms/info/article/getFwCate.jsp?site_id="+site_id+"&app_id="+app_id+"&ids="+ids+"&is_Publish="+isPublish,500,430);
}

function checkAllData(obj)
{
	$("#data :checkbox").checkAll($(obj).attr("checked"));
}
