...
<script type="text/javascript" src="js/info.js?v=20150807"></script>
...
{
	top.OpenModalWindow("信息报送","/manager/cms/info/article/getReceiveSite.jsp?site_id="+site_id+"&app_id="+app,570,420);
}
...
<div class="infoListTable hidden" id="listTable_7"> 
<table class="table_option" border="0" cellpadding="0" cellspacing="0"> 
	<tr> 
		<td align="left" valign="middle"> 
