...
<script type="text/javascript" src="js/m_pic.js"></script>
<style>
#add_pic_table div{color:#32609E}
</style>
...
$(document).ready(function(){
	...
	publicUploadButtomLoad("uploadify_pic",true,true,"",0,5,getReleSiteID(),"savePicUrl");
...
<input id="model_id" type="hidden" value="<%=model%>" />
...
<table id="" class="table_form" border="0" cellpadding="0" cellspacing="0">
	<tbody>
		...
		<tr>
			...
			<td style="">
				<textarea id="pic_content" name="pic_content" style="width:90%;height:300px;visibility:hidden;"></textarea>
