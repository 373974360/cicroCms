...
<script type="text/javascript" src="js/info.js?v=20150706"></script>
...
function getFWInfo()
{
	...
	top.OpenModalWindow("信息高级获取","/manager/cms/info/article/fwInfoGet.jsp?cat_id="+cid+"&app_id="+app,800,530);
}
