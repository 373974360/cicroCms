		...
		<table id="table" class="table_form" border="0" cellpadding="0" cellspacing="0">
			<tbody>
				...
				<tr>
				 <th>权重：</th>
				 <td>
					从&nbsp;<input id="start_weight" name="start_weight" type="text"  style="width:80px" maxlength="3" onkeypress="var k=event.keyCode; return k>=48&&k<=57" onpaste="return !clipboardData.getData('text').match(/\D/)" ondragenter="return false" style="ime-mode:Disabled"/>
					到&nbsp;<input id="end_weight" name="end_weight" type="text" style="width:80px" maxlength="3" onkeypress="var k=event.keyCode; return k>=48&&k<=57" onpaste="return !clipboardData.getData('text').match(/\D/)" ondragenter="return false" style="ime-mode:Disabled"/>
				 </td>
				</tr>
				<tr>
				 <th>作者：</th>
