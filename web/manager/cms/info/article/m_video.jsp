...
<script type="text/javascript" src="js/m_video.js"></script>
...
$(document).ready(function(){
	...
	if(infoid != "" && infoid != "null" && infoid != null){		
		defaultBean = ModelUtilRPC.select(infoid,site_id,"video");
...
<table id="" class="table_form" border="0" cellpadding="0" cellspacing="0">
	<tbody>
		...
		<tr>
			...
			<td style="">
				<textarea id="info_content" name="info_content" style="width:90%;height:300px;visibility:hidden;"></textarea>
			</td>
		</tr>
		<tr>
			<th>缩略图：</th>
