...
<table id="" class="table_form" border="0" cellpadding="0" cellspacing="0">
	<tbody>
		<tr>
			<th style="vertical-align:top;">承办科室：</th>
			<td>
				<input id="gk_dz" name="gk_dz" type="text" style="width:350px;" value="" />
			</td>
		</tr>
		<tr>
			<th style="vertical-align:top;">政策法规依据：</th>
			<td style="">
        ...
        <tr>
			<th style="vertical-align:top;">处罚种类：</th>
			<td style="">
		...
		<tr>
			<th style="vertical-align:top;">处罚标准：</th>
			<td style="">
				<textarea id="gk_xmzw" name="gk_xmzw" style="width:620px;;height:160px;visibility:hidden;"></textarea>
			<span class="blank9"></span>
			</td>
		</tr>
		<tr>
			<th style="vertical-align:top;">办理时限：</th>
			<td>
        ...
        <tr>
			<th style="vertical-align:top;">联系方式：</th>
			<td>
				<input id="gk_yzbm" name="gk_yzbm" type="text" style="width:350px;" value="" />
			</td>
		</tr>
        <tr>
			<th style="vertical-align:top;">申诉途径：</th>
			<td>
		...
		<input type="hidden" id="gk_sltsbm" name="gk_sltsbm" value="" />
		<input type="hidden" id="gk_sltsdh" name="gk_sltsdh" value="" />
		
         <tr>
			<th style="vertical-align:top;">乘车路线：</th>
			<td>
