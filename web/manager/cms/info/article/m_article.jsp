...
function changePress(obj)
{
	if($("#" + obj).attr("checked"))
	{
		...
		publicUploadButtomLoad("uploadify",true,false,"",1,9,getReleSiteID(),"savePicUrl");
	}
	else
	{
		$("#uploadifyUploader").remove();
...
<table id="" class="table_form" border="0" cellpadding="0" cellspacing="0">
	<tbody>
		<tr>
			...
			<td style="">
				<textarea id="info_content" name="info_content" style="width:90%;height:400px;visibility:hidden;"></textarea>
		...
		<tr>
			<th style="vertical-align:top;">是否添加水印：</th>
			<td style="">
				<input id="is_press" name="is_press" type="checkbox" checked="checked" onclick="changePress('is_press')"/><label for="is_remote">是否添加水印</label>&nbsp;&nbsp;
				<span class="blank9"></span>
			</td>
		</tr>
		<tr>
