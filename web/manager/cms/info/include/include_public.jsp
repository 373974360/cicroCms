...
<table id="" class="table_form table_option" border="0" cellpadding="0" cellspacing="0">
	<tbody>
		<tr>
			...
			<th style=" width:80px;"  id="t3" class="hidden">所属专题：</th>
			<td style=" width:120px;"  id="t4" class="hidden">
	...
	<tbody>
		<tr>
			...
			<td>
				...
				<input id="title" name="title" type="text" class="width350" value="" onkeypress="showStringLength('title','wordnum')" onkeyup="showStringLength('title','wordnum')"  onblur="checkInputValue('title',false,1000,'信息标题','')"/>
		...
		<tr id="topTitleTr" style="display:none;">
			<th>上标题：</th>
			<td>
				<input id="top_title" name="top_title" type="text" class="width350" value="" onkeypress="showStringLength('top_title','wordnum3')" onkeyup="showStringLength('top_title','wordnum3')" onblur="checkInputValue('top_title',true,1000,'上标题','')"/>
		...
		<tr id="subTitleTr" style="display:none;">
			<th>副标题：</th>
			<td>
				<input id="subtitle" name="subtitle" type="text" class="width350" value="" onkeypress="showStringLength('subtitle','wordnum2')" onkeyup="showStringLength('subtitle','wordnum2')" onblur="checkInputValue('subtitle',true,1000,'副标题','')"/>
