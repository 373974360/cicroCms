...
<table id="" class="table_form" border="0" cellpadding="0" cellspacing="0">
	<tbody>
		<tr>
			<th>主题关键词：</th>
			<td class="width250">
				<input id="topic_key" name="topic_key" type="text" class="width200" maxlength="80" value="" onblur="checkInputValue('topic_key',true,500,'主题关键词','')"/>
			</td>
...
<table id="" class="table_form" border="0" cellpadding="0" cellspacing="0">
	<tbody>
    	<tr>
			<th>索引号：</th>
			<td>
				<input type="text" id="gk_index" name="gk_index"  style="background-color:#F0F0EE;"  class="width200" value="" />
