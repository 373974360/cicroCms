...
function openSelectPage(){
	top.OpenModalWindow("选择站点下的栏目","/manager/cms/cmsCount/cateSelect.jsp?site_id="+site_id,318,480);
}
</script>
</head>
<body>
<table style="width:700px;margin:0px;" border="0" cellpadding="0" cellspacing="0" >
    <tr>
    	<td>
        ...
        <div style="float:left">
        	<input name="all_cat_ids" type="checkbox" class="checkBox_mid" onclick="allSelected()" value="1"/>一组
        	<input name="all_cat_ids" type="checkbox" class="checkBox_mid" onclick="allSelected()" value="2"/>二组
        	<input name="all_cat_ids" type="checkbox" class="checkBox_mid" onclick="allSelected()" value="3"/>三组
        	&nbsp;&nbsp;&nbsp;
...
<table style="width:700px;margin:0px;">
    ...
    <tr valign="top">
     	<td>
       <div id="count">
       		<table id="countList" class="treeTableCSS table_border" style="width:700px;margin:0px;"  border="0" cellpadding="0" cellspacing="0">
       		</table>
       </div>
       </td>
     </tr>
