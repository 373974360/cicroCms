...
<script type="text/javascript" src="js/cmsCountListCate.js"></script>
...
function setCountType(){
    if($("#count_type").val()=="0"){
          window.location.href="/manager/cms/cmsCount/cmsCountList.jsp?site_id="+site_id;
	}
}
...
<table style="width:100%" border="0" cellpadding="0" cellspacing="0" >
   <tr>
	<td colspan="2"  class="search_td fromTabs">
            ...
            <select id="count_type" onchange="setCountType()">
			   ...
			   <option value="1" selected="selected">按栏目统计</option>
            </select>
