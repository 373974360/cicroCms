...
function showList(){
	...
	if(statu) {
		...
		for(var i = 0; i < group.length; i++)
		{
			if(group[i] == 1)
			{
				group_ids += "2377,3288,2158,13740,15786,15792,4643,4664,4697,4703,4743,4718,16553,15062,15872,15686,12744,12674,1616,9778,11621,1578,15604,16922";	//第一组维护栏目
			}else if(group[i] == 2)
			{
				group_ids += ",2163,6946,15693,15826,4690,12792,13249,4749,4681,13889,13661,13819";	//第二组维护栏目
			}else
			{
				group_ids += ",16302,1812,4738,4652,4681,1315,2156,13264,4757,4944,15814,1492,3510,15766";	//第三组维护栏目
			}
		}
		if(group_ids.startWith(","))
		{
