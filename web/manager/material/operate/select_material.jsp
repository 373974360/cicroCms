...
$(document).ready(function(){
	...
	imgDomain = MateInfoRPC.getImgDomain(site_id);
	initButtomStyle();
	init_input();
	iniLeftMenuTree();
	...
	<tr>
	 <td width="160px" valign="top">
		<div id="leftMenuBox">
			...
			<div><input type="text" id="searchkey" name="searchkey" style="width:110px"><input id="searchButton" name="btn1" type="button" onclick="searchMaterial()" value="搜索" /></div>
		</div>
	 </td>
	 <td class="width10"></td>
	 <td valign="top">		
		<table class="table_option fromTabs" border="0" cellpadding="0" cellspacing="0">
			<tr>		
				<td align="left" valign="middle" style="padding-top:4px;" width="200px">
		...
		<div id="SucaiListArea" class="contentBox6">
			<ul id="sucaiList" class="imgList" style="width:510px">
			</ul>
			<span class="blank3"></span>
		</div>	
	 </td>
