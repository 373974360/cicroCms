...
var TemplateVerBean = new Bean("com.cicro.wcm.bean.system.template.TemplateVerBean",true);
...
function showList(){	
	...
	table.getCol("t_cname").each(function(i){
		...
		if(i>0)
		{			
			//$(this).html('<a href="javascript:top.addTab(true,\'/manager/system/template/template_view.jsp?t_id='+beanList.get(i-1).t_id+'\',\'模板信息\')">'+beanList.get(i-1).t_cname+'</a>');
		}
	});
