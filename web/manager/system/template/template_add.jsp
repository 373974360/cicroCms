...
<script type="text/javascript" src="/manager/js/jquery_selecter.js"></script>
...
$(document).ready(function(){
	...
	{		
		...
		if(defaultBean)
		{
			...
			$("#t_content").val(defaultBean.t_content);
		}
				...
				<table border="0" cellpadding="0" cellspacing="0" style="width:100%;height:407px;">
					<tr>
						<td style="border:1px solid #9DBFDD;">
							...
							<textarea id="t_content" name="t_content" style="width:100%;height:437px;"></textarea>	
						</td>
