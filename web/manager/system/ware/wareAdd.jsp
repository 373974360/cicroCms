...
<script type="text/javascript" src="/manager/js/mCodeArea/js/codemirror.js"></script>
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		mCodeIconMouse();///manager/js/mCodeArea/js/codemirror.js
	});
		...
		<tr>
			...
			<td style="border:1px solid #9DBFDD;">
				<div style="" id="m_code_editor">
				  <div class="code_icon">
					<img src='/manager/js/mCodeArea/images/creaList.png' width="20px" height="20px" alt="公用列表生成工具" style="padding:1px 2px;cursor:pointer" onclick="mCodeIconEvent('creaList')">
				  </div>
				  <div class="code_icon">
					<img src='/manager/js/mCodeArea/images/hotList.png' width="20px" height="20px" alt="热点信息生成工具" style="padding:1px 2px;cursor:pointer" onclick="mCodeIconEvent('hotList')">
				  </div>
				  <div class="code_icon">
					<img src='/manager/js/mCodeArea/images/creaLink.png' width="20px" height="20px" alt="获取链接地址工具" style="padding:1px 2px;cursor:pointer" onclick="mCodeIconEvent('creaLink')">
				  </div>
				  <div class="code_icon">
					<img src='/manager/js/mCodeArea/images/selImg.png' width="20px" height="20px" alt="选择图片" style="padding:1px 2px;cursor:pointer" onclick="mCodeIconEvent('selImg')">
				  </div>
				</div>
