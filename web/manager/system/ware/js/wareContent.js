...
{		
	if(ware_id != "" && ware_id != null)
	{
		...
		}else
		{
			...
			KE.html("ware_content",defaultBean.ware_content);
		}
	}	
}
...
{	
	defaultBean.ware_content = KE.html("ware_content");
...
function addInfo(obj)
{
	...
	sort_id += 1;
	top.OpenModalWindow("选择信息","/manager/system/ware/select_info_ref.jsp?winfo_id="+winfo_id+"&sort_id="+sort_id,630,460);
}
...
{
	top.OpenModalWindow("编辑信息","/manager/system/ware/update_ware_infos.jsp?id="+currnet_info_id,630,340);
}
...
{		
	...
	top.OpenModalWindow("选择信息","/manager/system/ware/select_info_ref.jsp?action_type=change&winfo_id="+currnet_winfo_id+"&sort_id="+sort_id,630,460);
}
