...
{
	top.OpenModalWindow("标签历史版本","/manager/system/ware/wareDataVerList.jsp?wareid="+ware_id+"&siteid="+site_id+"&appid="+app_id,1000,530);
}
...
function openAddPage()
{
	...
	window.location.href  = "/manager/system/ware/wareAdd.jsp?site_id="+site_id+"&type=add&app_id="+app_id+"&wcat_id="+id;
}
...
function openUpdatePage()
{
	...
	window.location.href  = "/manager/system/ware/wareAdd.jsp?site_id="+site_id+"&type=update&app_id="+app_id+"&wcat_id="+id+"&id="+selectediID;
}

function openUpdatePageByIndex(index, wcat_id)
{
	var bean = beanList.get(index);
	window.location.href = "/manager/system/ware/wareAdd.jsp?site_id="+site_id+"&type=update&app_id="+app_id+"&wcat_id="+wcat_id+"&id="+bean.id;
}
...
{
	window.location.href  = "/manager/system/ware/wareList.jsp?site_id="+site_id+"&app_id="+app_id+"&id="+wcat_id;
}
...
{	
	...
	addBean.ware_content = editAreaLoader.getCode();
...
function saveUpdateWare()
{
	...
	updateBean.ware_content = editAreaLoader.getCode();
	var recoveryType="update";
	if(WareRPC.updateWare(updateBean,recoveryType))
	{
...
function movWares(){
	...
	top.OpenModalWindow("新建标签分类","/manager/system/ware/mov_wares.jsp?ids="+arrIDS+"&site_id="+site_id,500,508);
}
