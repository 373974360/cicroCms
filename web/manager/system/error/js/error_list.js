var ErrorReportBean = new Bean("com.cicro.wcm.bean.system.error.ErrorReportBean",true);
var tp = new TurnPage();
var beanList = null;
var con_m = new Map();
var table = new Table();	
...
{
	var selectIDS = table.getSelecteCheckboxValue("id");
	top.OpenModalWindow("操作信息","/manager/system/error/error_opt.jsp?id="+selectIDS,700,450);
}
...
function viewFun()
{
	var selectIDS = table.getSelecteCheckboxValue("id");
	var selectIDS = table.getSelecteCheckboxValue("id");
	top.OpenModalWindow("查看详细信息","/manager/system/error/error_view.jsp?id="+selectIDS,700,450);
}
