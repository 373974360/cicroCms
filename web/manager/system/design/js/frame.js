...
var DesignFrameBean = new Bean("com.cicro.wcm.bean.system.design.DesignFrameBean",true);
...
{		
	top.addTab(true,"/manager/system/design/frame_add.jsp?app_id="+app_id+"&top_index="+top.curTabIndex,"维护外框样式");
}
...
function openUpdateDesignFramePage(c_id)
{
	...
	top.addTab(true,"/manager/system/design/frame_add.jsp?app_id="+app_id+"&top_index="+top.curTabIndex+"&frame_id="+id,"维护外框样式");
}
