...
var DesignStyleBean = new Bean("com.cicro.wcm.bean.system.design.DesignStyleBean",true);
...
{	
	top.OpenModalWindow("维护内容样式","/manager/system/design/style_add.jsp?app_id="+app_id,480,230);
}
...
function openUpdateDesignStylePage(c_id)
{
	...
	top.OpenModalWindow("维护内容样式","/manager/system/design/style_add.jsp?app_id="+app_id+"&style_id="+id,480,230);
}
