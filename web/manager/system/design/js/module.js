...
var DesignModuleBean = new Bean("com.cicro.wcm.bean.system.design.DesignModuleBean",true);
...
{		
	top.addTab(true,"/manager/system/design/module_add.jsp?app_id="+app_id+"&top_index="+top.curTabIndex,"维护模块");
}
...
function openUpdateDesignModulePage(c_id)
{
	...
	top.addTab(true,"/manager/system/design/module_add.jsp?app_id="+app_id+"&top_index="+top.curTabIndex+"&module_id="+id,"维护模块");
}
