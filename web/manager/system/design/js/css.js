...
var DesignCSSBean = new Bean("com.cicro.wcm.bean.system.design.DesignCSSBean",true);
...
{	
	top.OpenModalWindow("维护主题风格","/manager/system/design/css_add.jsp?app_id="+app_id,480,230);
}
...
function openUpdateDesignCssPage(c_id)
{
	...
	top.OpenModalWindow("维护主题风格","/manager/system/design/css_add.jsp?app_id="+app_id+"&css_id="+id,480,230);
}
