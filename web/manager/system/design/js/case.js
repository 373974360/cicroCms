...
var DesignCaseBean = new Bean("com.cicro.wcm.bean.system.design.DesignCaseBean",true);
...
{		
	top.addTab(true,"/manager/system/design/case_add.jsp?app_id="+app_id+"&top_index="+top.curTabIndex,"维护方案套餐");
}
...
function openUpdateDesignCasePage(c_id)
{
	...
	top.addTab(true,"/manager/system/design/case_add.jsp?app_id="+app_id+"&top_index="+top.curTabIndex+"&case_id="+id,"维护方案套餐");
}
