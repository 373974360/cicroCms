...
var DesignLayoutBean = new Bean("com.cicro.wcm.bean.system.design.DesignLayoutBean",true);
...
{		
	top.addTab(true,"/manager/system/design/layout_add.jsp?app_id="+app_id+"&top_index="+top.curTabIndex,"维护布局");
}
...
function openUpdateDesignLayoutPage(c_id)
{
	...
	top.addTab(true,"/manager/system/design/layout_add.jsp?app_id="+app_id+"&top_index="+top.curTabIndex+"&layout_id="+id,"维护布局");
}
