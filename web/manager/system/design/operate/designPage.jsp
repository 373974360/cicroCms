...
<link rel="stylesheet" type="text/css" href="/manager/js/jquery-easyui/style/easyui.css">
<link rel="stylesheet" type="text/css" href="/wcm.files/design/styles/default.css" />
<link type="text/css" rel="stylesheet" href="/wcm.files/styles/group.css" />
<link rel="stylesheet" type="text/css" href="/manager/styles/design.css">
<link rel="stylesheet" type="text/css" href="/manager/styles/themes/default/tree.css">
<link rel="stylesheet" type="text/css" href="/manager/styles/themes/icon.css">
<link rel="stylesheet" type="text/css" href="/manager/js/jquery-ui/themes/base/jquery.ui.all.css"  />
...
<script type="text/javascript" src="/manager/js/indexjs/indexList.js"></script>
<script type="text/javascript" src="/manager/js/indexjs/tools.js"></script>
<script type="text/javascript" src="/manager/js/lang/zh-cn.js"></script>
<script type="text/javascript" src="/manager/js/jquery-plugin/colResizable-1.3.min.js"></script>
<script type="text/javascript" src="/manager/js/jTimers.js"></script>
<script type="text/javascript" src="/manager/js/jquery-plugin/jquery.cookie.js"></script>
<script type="text/javascript" src="/manager/js/jquery-ui/jquery.effects.core.js"></script>
<script type="text/javascript" src="/manager/js/jquery-ui/jquery.effects.blind.js"></script>
<script type="text/javascript" src="/manager/js/jquery-easyui/jquery.easyui.min.js"></script> 
<script type="text/javascript" src="/manager/js/jquery-ui/jquery.ui.core.js"></script>
<script type="text/javascript" src="/manager/js/jquery-ui/jquery.ui.widget.js"></script>
<script type="text/javascript" src="/manager/js/jquery-ui/jquery.ui.mouse.js"></script>
<script type="text/javascript" src="/manager/js/jquery-ui/jquery.ui.button.js"></script>
<script type="text/javascript" src="/manager/js/jquery-ui/jquery.ui.draggable.js"></script>
<script type="text/javascript" src="/manager/js/jquery-ui/jquery.ui.position.js"></script>
<script type="text/javascript" src="/manager/js/jquery-ui/jquery.ui.dialog.js"></script>
<script type="text/javascript" src="/manager/js/jquery-ui/jquery.ui.sortable.js"></script>
...
<style type="text/css">
	*{
	...
	.design_head{width:100%;height:42px;padding-top:5px;background-image:url('/manager/images/desing_bak.jpg');background-repeat:repeat}
	
	li{list-style-type:none;list-style:none;}
	#msgAlert .alert_img{background:url('/manager/images/alert.png') no-repeat center center;}
	#msgAlert .error_img{background:url('/manager/images/error.png') no-repeat center center;}
	#msgAlert .wargin_img{background:url('/manager/images/wargin.png') no-repeat center center;}
	#msgConfirm .back_img{background:url('/manager/images/confirm.png') no-repeat center center;}
	...
	a.save_btn{width:85px;height:26px; display:block; background:url('/manager/images/design_btn.jpg') right top no-repeat; border:0}
	a.save_btn:hover{background:url('/manager/images/design_btn.jpg') right bottom no-repeat;}

	a.cancel_btn{width:85px;height:26px; display:block; background:url('/manager/images/design_btn.jpg') left top no-repeat; border:0}
	a.cancel_btn:hover{background:url('/manager/images/design_btn.jpg') left bottom no-repeat;}
	</style>
	...
	function loadCssObject(css_id)
	{
		...
		if(css_obj != null)
		{
			$("#css_link").attr("href","/wcm.files/design/theme/"+css_obj.css_ename+"/theme.css")
		}
	}
	...
	{		
		...
		//模板Bean
		var template_bean = BeanUtil.getCopy(new Bean("com.cicro.wcm.bean.system.template.TemplateEditBean",true));
		...
		//页面设计Bean
		var designCategoryBean = BeanUtil.getCopy(new Bean("com.cicro.wcm.bean.system.design.DesignCategoryBean",true));
	...
	function getCodeHandl(body_str,code_str)
	{
		...
		html_str += '<link type="text/css" rel="stylesheet" href="/wcm.files/styles/group.css" />\n';
		html_str += '<link rel="stylesheet" type="text/css" href="'+$("#css_link").attr("href")+'">\n';
		html_str += '<link rel="stylesheet" type="text/css" href="/wcm.files/design/styles/default.css" />\n';
		...
		html_str += '<script type="text/javascript" src="/wcm.files/js/jquery.js"><'+'/script>\n';
...
<div class="layout_top_button"><img src="/manager/images/layout_edit.jpg" width="32" height="32" alt="" /></div>
<div class="module_top_button"><img src="/manager/images/module_edit.jpg" width="32" height="32" alt="" /></div>
...
<div id="sysDialog" name="sysDialog" class="hidden" title="My Window">
	<iframe id="sysDialog_Frame" name="sysDialog_Frame" src="/manager/spaceIframe.html" width="100%" height="100%" frameborder="0" scrolling="auto"></iframe>
</div>
