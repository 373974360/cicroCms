...
function getFrameList()
{
	if(frameList == null)
	{
		...
		{
			var tmpPicLi = "<li style='width:125px;height:130px;padding:0px 5px'><div style='width:100%;text-align:ceter'><img src='/wcm.files/design/theme/"+css_ename+"/thumb/"+frameList.get(i).thumb_url+"' style='width:120px;height:100px' align='center'/></div>";
