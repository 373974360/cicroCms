...
var AuthorBean = new Bean("com.cicro.wcm.bean.system.assist.AuthorBean",true);
...
{	//OpenModalWindow
	top.OpenModalWindow("查看","/manager/system/assist/author/author_view.jsp?author_id="+author_id,380,195);	
}

//打开添加窗口
function openAddAuthorPage()
{
	top.OpenModalWindow("维护","/manager/system/assist/author/author_add.jsp?app="+app+"&site_id="+site_id,380,195);	
}
...
function openUpdateAuthorDataPage()
{
	...
	top.OpenModalWindow("维护","/manager/system/assist/author/author_add.jsp?author_id="+selectIDS,380,195);
}

function openUpdatePage(authorid)
{
	top.OpenModalWindow("维护","/manager/system/assist/author/author_add.jsp?author_id="+authorid,380,195);
}
