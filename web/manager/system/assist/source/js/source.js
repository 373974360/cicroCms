...
{
	top.OpenModalWindow("维护来源","/manager/system/assist/source/source_add.jsp?app="+app+"&site_id="+site_id,380,215);	
}
...
function openUpdateSourceDataPage()
{
	...
	top.OpenModalWindow("维护来源","/manager/system/assist/source/source_add.jsp?source_id="+selectIDS,380,215);
}

function openUpdatePage(sourceid){
	top.OpenModalWindow("维护来源","/manager/system/assist/source/source_add.jsp?source_id="+sourceid,380,215);
}
