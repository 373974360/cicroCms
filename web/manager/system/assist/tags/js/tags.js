...
var TagsBean = new Bean("com.cicro.wcm.bean.system.assist.TagsBean",true);
...
{	//OpenModalWindow
	top.OpenModalWindow("Tag查看","/manager/system/assist/tags/tags_view.jsp?tag_id="+tag_id,385,215);	
}

//打开添加窗口
function openAddTagPage()
{
	top.OpenModalWindow("维护Tag","/manager/system/assist/tags/tags_add.jsp?app="+app+"&site_id="+site_id,385,215);	
}
...
function openUpdateTagDataPage()
{
	...
	top.OpenModalWindow("维护Tag","/manager/system/assist/tags/tags_add.jsp?tag_id="+selectIDS,385,215);
}

function openUpdataPage(tagid){
	top.OpenModalWindow("维护Tag","/manager/system/assist/tags/tags_add.jsp?tag_id="+tagid,385,215);
}
