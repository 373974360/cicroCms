...
var ModelFieldBean = new Bean("com.cicro.wcm.bean.system.formodel.ModelFieldBean",true);
...
{	
	top.OpenModalWindow("查看内容模型字段","/manager/system/formodel/field_view.jsp?field_id="+r_id,450,285);	
}

//打开添加窗口
function openAddFieldPage()
{
	top.OpenModalWindow("维护内容模型字段","/manager/system/formodel/field_add.jsp?model_id="+model_id,450,285);	
}
...
function openUpdateFieldPage()
{
	...
	if(selectList.get(0).table_name != "cs_info_udefined")
	{
		...
		top.OpenModalWindow("维护内容模型字段","/manager/system/formodel/field_add.jsp?field_id="+selectList.get(0).field_id,450,285);	
}
