...
<%@page import="com.cicro.wcm.services.search.search.SearchManager"%>
<%@page import="com.cicro.util.Encode"%>
<%@page import="com.cicro.wcm.services.search.search.util.SearchUtil"%>
...
<%
        ...
        String q = SearchUtil.getXmlParam(request);
        com.cicro.wcm.bean.search.SearchResult searchResult = SearchManager.searchGJ(q);
  ...
  <body background="http://www.yplib.org.cn/structure/index.files/bj.gif">
	...
	<table cellspacing=0 cellpadding=0 width=952 border=0 align="center" class="table_border" >
	 ...
	 <tr>
	  ...
	  <form action="searchResultGJ.jsp" name="form1" id="form1" method="get">
