...
var DataDictBean = new Bean("com.cicro.wcm.bean.system.dict.DataDictBean",true);
var DataDictCategoryBean = new Bean("com.cicro.wcm.bean.system.dict.DataDictCategoryBean",true);
...
function addDictionaryList(){
	...
	$("#dictData tr").each(function(){
		...
		dbean.is_defult=($(this).find(":checkbox[name='isdefault'][checked]").attr("checked") ? "1" : "0");
		dbean.app_id=app;
