...
$(document).ready(function(){
	...
	if(id != "" && id != null)
	{
		...
		if(defaultBean != null)
		{
			...
			KE.html("reply_content",defaultBean.reply_content);
		}

		$("#addButton").click(updateGuestbook);
	}
	getGBClassList();
});
init_editer("content");
init_editer("reply_content");
...
<table class="table_option" border="0" cellpadding="0" cellspacing="0">
	<tr>
		<td align="left" valign="middle" style="text-indent:100px;">
			...
			<input id="userAddReset" name="btn1" type="button" onclick="formReSet('guestbook_table',id)" value="重置" />	
