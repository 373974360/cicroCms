...
var GuestBookClass = new Bean("com.cicro.wcm.bean.appCom.guestbook.GuestBookClass",true);
...
{
	top.OpenModalWindow("维护类别","/manager/appCom/guestbook/add_gbClass.jsp?cat_id="+cat_id+"&site_id="+site_id+"&="+top.curTabIndex,550,250);
}
...
function openUpdateGuestBookClassPage(s_id)
{
	...
	top.OpenModalWindow("维护类别","/manager/appCom/guestbook/add_gbClass.jsp?class_id="+id,550,250);
}
