...
var GuestBookCategory = new Bean("com.cicro.wcm.bean.appCom.guestbook.GuestBookCategory",true);
...
{
	top.addTab(true,"/manager/appCom/guestbook/add_gbSub.jsp?cat_id="+cat_id+"&site_id="+site_id+"&topnum="+top.curTabIndex,"新建主题");
}
...
{
	top.addTab(true,"/manager/appCom/guestbook/add_gbCategory.jsp?site_id="+site_id+"&topnum="+top.curTabIndex,"新建分类");
}
...
function openUpdateGuestBookCategoryPage(s_id)
{
	...
	top.addTab(true,"/manager/appCom/guestbook/add_gbCategory.jsp?site_id="+site_id+"&topnum="+top.curTabIndex+"&cat_id="+id,"新建分类");
}

//打开查看类别管理窗口
function openGuestBookPage(s_id)
{
	top.addTab(true,"/manager/appCom/guestbook/gbClassList.jsp?site_id="+site_id+"&topnum="+top.curTabIndex+"&cat_id="+s_id,"类别管理");
}
