...
var GuestBookSub = new Bean("com.cicro.wcm.bean.appCom.guestbook.GuestBookSub",true);
...
{
	top.addTab(true,"/manager/appCom/guestbook/add_gbSub.jsp?site_id="+site_id+"&topnum="+top.curTabIndex,"新建主题");
}
...
function openUpdateGuestBookSubPage(s_id)
{
	...
	top.addTab(true,"/manager/appCom/guestbook/add_gbSub.jsp?site_id="+site_id+"&topnum="+top.curTabIndex+"&gbs_id="+id,"新建主题");
}

//打开查看留言窗口
function openGuestBookPage(s_id,cat_id)
{
	top.addTab(true,"/manager/appCom/guestbook/guestBookList.jsp?site_id="+site_id+"&topnum="+top.curTabIndex+"&gbs_id="+s_id+"&cat_id="+cat_id,"查看留言");
}

//打开统计窗口
function openGuestBookCountPage(s_id,cat_id)
{
	top.addTab(true,"/manager/appCom/guestbook/guestBookCount.jsp?site_id="+site_id+"&gbs_id="+s_id+"&cat_id="+cat_id,"留言统计");
}
...
function insertGuestbookSub()
{
	...
	bean.description = KE.html("description");
