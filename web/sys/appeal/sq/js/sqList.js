...
{
	top.addTab(true,"/sys/appeal/sq/sq_add.jsp?sq_id="+s_id+"&top_index="+top.curTabIndex,"信件管理");	
	//window.location.href = "/sys/appeal/sq/sq_add.jsp?sq_id="+s_id;
}

function openSQManager2(s_id)
{
	top.addTab(true,"/sys/appeal/sq/sq_add2.jsp?sq_id="+s_id+"&top_index="+top.curTabIndex,"信件管理");	
	//window.location.href = "/sys/appeal/sq/sq_add.jsp?sq_id="+s_id;
}
