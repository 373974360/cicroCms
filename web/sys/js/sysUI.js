...
{
	window.showModalDialog("/sys/material/operate/select_material.jsp?i_type="+i_type+"&site_id="+site_id+"&handl_name="+handl_name,window,'dialogWidth:700px;dialogHeight:550px;scroll:no;status:no;center:yes');
}
