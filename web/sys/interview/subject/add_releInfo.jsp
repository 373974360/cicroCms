	...
	<tbody>
		...
		<tr id="urlcontent" height="30" style="display:none;">
		 ...
		 <tr id="htmlcontent" style="display:none;">
		  ...
		  <td>
			<textarea id="content" name="content" style="width:620px;;height:400px;visibility:hidden;"></textarea>
		   </td>
		 </tr>
 </tbody>
</table>
...
<table class="table_option" border="0" cellpadding="0" cellspacing="0">
	<tr>
		<td align="left" valign="middle" style="text-indent:100px;">
			...
			<input id="userAddReset" name="btn1" type="button" onclick="formReSet('subReleInfo',id);KE.html('content','')" value="重置" />	
