...
<meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
	...
	<!-- <script type="text/javascript" src="/wcm.files/component/common/htmledit/editor/js/cicroUtil.js"></script>
	<script type="text/javascript" src="/wcm.files/component/common/htmledit/fckeditor.js"></script> -->
    ...
    init_editer("history_record_pic");
		init_editer("history_record_text");
		function getHistoryRecord()
		{
			...
			KE.html("history_record_pic",defaultBean.history_record_pic);
			KE.html("history_record_text",defaultBean.history_record_text);
		}		
		...
		function getChatValueHandl()
		{
			...
			if(l != null)
			{
				...
				oEditor.SetHTML(str);*/
				KE.html('history_record_'+chat_type,str);
			}			
		}
		...
		{/*
			...
			$("#history_record_pic").val(KE.html("history_record_pic"));
			$("#history_record_text").val(KE.html("history_record_text"));
...
<table id="jcxx_tab" class="table_form" border="0" cellpadding="0" cellspacing="0">
	<tbody>
		<tr>
		 <td>
			<textarea id="history_record_pic" name="history_record_pic" style="width:700px;height:400px"></textarea>
		  <!-- <div style="display:none"><textarea id="history_record_pic" name="history_record_pic" ></textarea></div>
			<script type="text/javascript">
				...
				var sBasePath = "/wcm.files/component/common/htmledit/";
...
<table id="xwg_tab" class="table_form" border="0" cellpadding="0" cellspacing="0">
	<tbody>
		<tr>
		 <td>
		 <textarea id="history_record_text" name="history_record_text" style="width:700px;height:400px"></textarea>
		 <!-- 
