...
{
	var map = new Map();
	if($("#is_wf_id").attr("checked") == true || $("#is_wf_id").attr("checked") == "checked")
	{
		map.put("wf_id",$("#wf_id :selected").val());
	}
	if($("#is_publish").attr("checked") == true || $("#is_publish").attr("checked") == "checked")
	{
		map.put("is_wf_publish",$(":checked[id='is_wf_publish']").val());
	}
	if($("#is_template_index").attr("checked") == true || $("#is_template_index").attr("checked") == "checked")
	{
		map.put("template_index",$("#template_index").val());
	}
	if($("#is_template_list").attr("checked") == true || $("#is_template_list").attr("checked") == "checked")
	{
		map.put("template_list",$("#template_list").val());
	}
	if($("#is_comment").attr("checked") == true || $("#is_comment").attr("checked") == "checked")
	{
		map.put("is_allow_comment",$(":checked[id='is_allow_comment']").val());
	}
	if($("#is_show_checkbox").attr("checked") == true || $("#is_show_checkbox").attr("checked") == "checked")
	{
