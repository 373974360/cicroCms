...
<%@ page import="com.cicro.wcm.services.model.services.*,com.cicro.wcm.services.model.*" %>
<%@page import="com.cicro.wcm.services.system.dict.DataDictRPC"%>
<%@page import="com.cicro.wcm.bean.system.dict.DataDictBean"%>
...
<script type="text/javascript" src="js/m_article_custom.js"></script>
