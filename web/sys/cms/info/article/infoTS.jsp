...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		<script type="text/javascript" src="js/toInfo.js"></script>
				...
				<tr>
					...
					<td >
						<ul id="type_ul">
						 ...
						 <li style="float:left; padding-right:20px;"><input type="radio" id="e" name="infostatus" value="1"/><label for="e">引用</label></li>
						 <li style="float:left; padding-right:20px;"><input type="radio" id="f" name="infostatus" value="2" checked="checked"/><label for="f">链接</label></li>
						</ul>	
					</td>
				</tr>				
			</tbody>
