var GKFXsjgbBean = new Bean("com.cicro.wcm.bean.cms.info.GKFXsjgbBean",true);

function getV(){
	return KE.html(gk_gzzz);
}
...
{	
	...
	var bean = BeanUtil.getCopy(GKFXsjgbBean);	
	...
	bean.gk_gzzz = replace_img_content;	
	...
	publicSaveInfoEvent(bean,"gkfxsjg","insert");
}
//修改
function updateInfoData()
{
	...
	publicSaveInfoEvent(bean,"gkfxsjg","update");
}