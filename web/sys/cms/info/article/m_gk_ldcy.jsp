...
<table id="" class="table_form" border="0" cellpadding="0" cellspacing="0">
	<tbody>
		<tr>
			...
			<td style="">
				<textarea id="gk_ldzw" name="gk_ldzw" style="width:620px;height:200px;visibility:hidden;"></textarea>
			</td>
		</tr>
        <tr>
			<th style="vertical-align:top;">个人简历：</th>
			<td style="">
				<textarea id="gk_grjl" name="gk_grjl" style="width:620px;height:200px;visibility:hidden;"></textarea>
        ...
        <tr>
			...
			<td style="">
				<textarea id="gk_gzfg" name="gk_gzfg" style="width:620px;height:200px;visibility:hidden;"></textarea>
			<span class="blank9"></span>
			</td>
		</tr>
		<tr>
