...
<table id="" class="table_form" border="0" cellpadding="0" cellspacing="0">
	<tbody>		
		<tr>
			...
			<td>
				<textarea id="description" name="description" style="width:620px;height:70px" onblur="checkInputValue('description',true,900,'内容概述','')"></textarea>
			</td>
		</tr>
	</tbody>
</table>
...
<table id="" class="table_form" border="0" cellpadding="0" cellspacing="0">
	<tbody>
		<tr>
			<th>主题关键词：</th>
			<td class="width250">
				<input id="topic_key" name="topic_key" type="text" class="width200" maxlength="80" value="" onblur="checkInputValue('topic_key',true,240,'主题关键词','')"/>
			</td>
			<th class="width70" >位置关键词：</th>
			<td class="width250">
				<input id="place_key" name="place_key" type="text" class="width200" maxlength="80" value="" onblur="checkInputValue('place_key',true,240,'位置关键词','')"/>
			</td>
            <td></td>
		</tr>
	</tbody>
