...
{
	window.open("/sys/system/design/operate/designPage.jsp?cat_id="+d_cat_id+"&site_id="+site_id+"&app_id="+app_id+"&c_name="+encodeURI(d_c_name)+"&p_type="+d_page_type+"&create_type="+c_type+"&v_id="+v_id);
}
