...
function startCollection(rule_id){
	...
	window.location.href ="/manager/dataCollection/collProgress.jsp?rule_id="+rule_id+"&pageType="+pageType;
...
{
	top.addTab(true,"/manager/dataCollection/add_rule.jsp?rcat_id="+id+"&tab_index="+top.curTabIndex,"添加规则");
}
...
function updateRuleById()
{
	...
	top.addTab(true,"/manager/dataCollection/add_rule.jsp?type=update&id="+id+"+&tab_index="+top.curTabIndex,"修改规则");
}
