...
var QueryDicBean = new Bean("com.cicro.wcm.bean.query.QueryDicBean",true);
...
function insertQueryDicBean()
{
	...
	$("#from_table tr").each(function(i){
		...
		qdc.is_selected =($(this).find(":checkbox[name='is_selected'][checked]").attr("checked") ? "1" : "0");
		qdc.is_query =($(this).find(":checkbox[name='is_query'][checked]").attr("checked") ? "1" : "0");
		qdc.is_result =($(this).find(":checkbox[name='is_result'][checked]").attr("checked") ? "1" : "0");
