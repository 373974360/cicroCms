...
var GKFtygsBean = new Bean("com.cicro.wcm.bean.cms.info.GKFtygsBean",true);
...
function pubCollDataInfotoCat()
{
	...
	for(var i=0;i<artBeanList.size();i++)
	{
		...
		var info_siteId = CategoryRPC.getCategoryBean(artBeanList.get(i).cat_id).site_id;
		if(artBeanList.get(i).model_id == "11")
		{
			...
			article_bean.site_id = info_siteId;
		...
		if(artBeanList.get(i).model_id == "14")
		{
			...
			//索引码生成
			var index_map = IndexRPC.getIndex(info_siteId,tygs_bean.cat_id,"","");
