...
function initPage()
{
	if(type == "unchecked")
	{
		con_m.put("cmt_status", "0");
	}
	else
	{
		$("#btn1").hide();
		$("#btn4").hide();
		con_m.put("cmt_status", "1");
	}
	setURLPara(con_m);
}
...
<table class="table_option" border="0" cellpadding="0" cellspacing="0" >
	<tr>
		<td align="left" class="fromTabs width230" style="">
			<input id="btn1" name="btn1" type="button" onclick="multiSelect('batchCheckComment()')" value="通过" />
		...
		<td align="right" valign="middle" class="fromTabs">
			...
			<select id="searchFields" class="input_select">
				<option selected="selected" value="cmt_content">关键字</option>
				<option value="me_nickname">用户</option>
				<option value="cmt_ip">IP</option>
			</select>
...
<span class="blank3"></span>
<div>
<table id="cmt_table" class="table_border odd_even_list"  border="0" cellpadding="0" cellspacing="0">
	<thead>
		<tr>
...
<table class="table_option" border="0" cellpadding="0" cellspacing="0">
	<tr>
		<td align="left" valign="middle">
			<input id="btn4" name="btn4" type="button" onclick="multiSelect('batchCheckComment()')" value="通过" />
			<input id="btn5" name="btn5" type="button" onclick="deleteSelect('batchDeleteComment()')" value="删除" />
			<input id="btn6" name="btn6" type="button" onclick="clearPara()" value="刷新" />
