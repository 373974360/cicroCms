...
<%
		...
		String q = com.cicro.wcm.services.search.search.util.SearchUtil.getXmlParam(request);
		
        com.cicro.wcm.bean.search.SearchResult searchResult = SearchManager.search(q);
