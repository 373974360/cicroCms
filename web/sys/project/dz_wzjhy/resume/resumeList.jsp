...
<div>
	...
	<tr>
		<td align="left" valign="middle">			
			<input id="btn3" name="btn3" type="button" onclick="publicSelectCheckbox(table,'id','publishResumeBean(1)');" value="发布" />
			<input id="btn3" name="btn3" type="button" onclick="publicSelectCheckbox(table,'id','publishResumeBean(0)');" value="撤消发布" />
			<input id="btn3" name="btn3" type="button" onclick="deleteRecord(table,'id','deleteResumeBean()');" value="删除" />		
		</td>
	</tr>
   </table>	
</div>
