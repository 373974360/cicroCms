...
<%@page import="com.cicro.util.*,com.cicro.project.dz_siteError.*"%>
...
<%
	...
	*/
	...
	if(SiteErrorManager.insertSiteError(seb,null))
	{
		...
		out.println("<script>");
        out.println("top.alert('纠错信息提交成功，感谢您的参与！')");
        out.println("top.document.mainform.reset()");
    ...
    {
		out.println("<script>");
		out.println("top.alert('纠错信息添加失败，请重新提交')");
		out.println("</script>");
    }
