...
var ErrorHandleUserBean = new Bean("com.cicro.project.dz_siteError.ErrorHandleUserBean", true);
...
function openUpdateErrorHandleUserPage(id) {
    ...
    top.OpenModalWindow("纠错处理用户", "/manager/project/dz_siteError/viewErrorHandleUser.jsp?id=" + c_id +"&topnum="+top.curTabIndex, 385, 210);
...
function addInfo() {
    top.OpenModalWindow("纠错处理用户", "/manager/project/dz_siteError/viewErrorHandleUser.jsp?topnum="+top.curTabIndex, 385, 210);
}