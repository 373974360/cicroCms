    ...
    <table class="table_option" border="0" cellpadding="0" cellspacing="0" >
		<tr>		
			...
			<td align="left" valign="middle" id="dept_search" class="search_td fromTabs" >				
				名称：<input id="name" id="name" type="text" class="input_text" value=""  />
    ...
    <table class="table_option" border="0" cellpadding="0" cellspacing="0">
        <tr>
            <td align="left" valign="middle">
                ...
                <input id="btnUpdate" type="button" class="btn x2" value="修改" onclick="updateRecord(table,'id','openUpdateExamPage(id)');"/>
                ...
                <input id="btn3" name="btn3" type="button" onclick="deleteRecord(table,'id','deleteExam()');"
                       value="删除"/>
            </td>
        </tr>
    </table>
