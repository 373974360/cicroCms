...
var ExcelTitleBean = new Bean("com.cicro.project.scoreSearch.ExcelTitleBean", true);
...
function initTable() {
    ...
    colsList.add(setTitleClos("examName", "考试分类", "170px", "", "", ""));
...
function openUpdateExcelTitlePage(id) {
    ...
    top.OpenModalWindow("Excel表头信息", "/manager/project/scoreSearch/viewExcelTitle.jsp?id=" + c_id + "&topnum="+top.curTabIndex, 485, 373);
}
...
function addInfo() {
    top.OpenModalWindow("Excel表头信息", "/manager/project/scoreSearch/viewExcelTitle.jsp?topnum="+top.curTabIndex, 485, 373);
}
