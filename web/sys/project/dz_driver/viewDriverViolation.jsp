    ...
    <SCRIPT LANGUAGE="JavaScript">
        ...
        $(document).ready(function () {
            ...
            if (id != null && id.trim() != "") {
                ...
                if (defaultBean) {
                    $("#driverViolation_table").autoFill(defaultBean);
                }
            }
        });
    </SCRIPT>
	        ...
	        <table style="width:555px;" class="table_form" border="0" cellpadding="0" cellspacing="0" id="driverViolation_table"
	            ...
	            <tr>
	                ...
	                <td colspan="4" style="text-align:left;">
	                    <input type="text" id="name" name="name" class="width200"  value="" onblur="checkInputValue('name',false,300,'姓名','')"/>
	                </td>
	            </tr>
	            <tr>
	                <td><span class="f_red">*</span>车牌号码</td>
	                <td colspan="4" style="text-align:left;">
	                    <input type="text" id="carNo" name="carNo" class="width200" value="" onblur="checkInputValue('carNo',false,20,'车牌号码','')"/>
	                </td>
	            </tr>
	            <tr>
	                <td><span class="f_red">*</span>违规时间</td>
	                <td colspan="4" style="text-align:left;">
	                	<input id="violationTime" name="violationTime" type="text"  onfocus="WdatePicker({dateFmt:'yyyy-MM-dd HH:mm:ss',isShowClear:true,readOnly:true})" readonly="readonly" onblur="checkInputValue('violationTime',false,20,'违规时间','')"/>
	                </td>
	            </tr>
	            <tr>
	                <td>违规行为</td>
    ...
    <table class="table_option" border="0" cellpadding="0" cellspacing="0">
        <tr>
            <td align="center" valign="middle">
                <input name="btn1" type="button" onclick="updateDriverViolationData()" value="保存"/>
                <input id="userAddReset" name="btn1" type="button" onclick="formReSet('driverViolation_table',id)" value="重置" />
