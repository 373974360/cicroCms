...
var ExcelTitleBean = new Bean("com.cicro.project.salarySearch.ExcelTitleBean", true);
...
function openUpdateExcelTitlePage(id) {
    ...
    top.OpenModalWindow("Excel表头信息", "/manager/project/salarySearch/viewExcelTitle.jsp?id=" + c_id + "&topnum="+top.curTabIndex, 485, 373);
}
...
function addInfo() {
    top.OpenModalWindow("Excel表头信息", "/manager/project/salarySearch/viewExcelTitle.jsp?topnum="+top.curTabIndex, 485, 373);
}
