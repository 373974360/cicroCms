...
var SalaryUserBean = new Bean("com.cicro.project.salarySearch.SalaryUserBean", true);
...
function showTurnPage(){
    ...
    tp.total = SalaryUserRPC.getSalaryUserCount(m2);
...
function openUpdateSalaryUserPage(id) {
    ...
    top.OpenModalWindow("人员信息", "/manager/project/salarySearch/viewSalaryUser.jsp?id=" + c_id + "&topnum="+top.curTabIndex, 485, 373);
}
...
function addInfo() {
    top.OpenModalWindow("人员信息", "/manager/project/salarySearch/viewSalaryUser.jsp?topnum="+top.curTabIndex, 485, 373);
}
