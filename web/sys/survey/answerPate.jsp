...
<head> 
	...
	<!--
		...
		var SurveyAnswer = new Bean("com.cicro.gpps.bean.survey.SurveyAnswer",true);
		var SurveyAnswerItem = new Bean("com.cicro.gpps.bean.survey.SurveyAnswerItem",true);
		var StatisticsBean = new Bean("com.cicro.gpps.bean.survey.StatisticsBean",true);
		var m;
