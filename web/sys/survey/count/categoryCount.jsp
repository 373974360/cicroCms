...
<head>
   ...
   $(document).ready(function () {	
	...
	function initTable(){
		...
		colsList.add(setTitleClos("c_name","问卷分类","","","",""));//英文名，显示名，宽，高，样式名，点击事件　
		colsList.add(setTitleClos("sur_count","问卷数","15%","","",""));	　
		colsList.add(setTitleClos("publish_count","发布问卷数","15%","","",""));
		colsList.add(setTitleClos("subject_count","问题总数","15%","","",""));
		colsList.add(setTitleClos("answer_count","答卷数","15%","","",""));
	...
	function showList(){	
		var m = SurveyRPC.getSurveyCategoryCount($("#start_time").val(),$("#end_time").val(),$("#time_type").val(),site_id);
		...
		if(m != null)
		{
			...
			///$("#excel_out").attr("href",m.get("file_path"));
	...
	<table class="table_option" border="0" cellpadding="0" cellspacing="0" >
		<tr>	
			...
			<td align="right" valign="middle" id="dept_search" class="search_td fromTabs" >
				<select id="time_type" name="time_type"><option value="add_time">按照创建时间统计</option><option value="publish_time">按照发布时间统计</option></select>
