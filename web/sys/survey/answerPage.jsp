...
<head> 
	...
	<!--
		...
		var SurveyAnswer = new Bean("com.cicro.wcm.bean.survey.SurveyAnswer",true);
		var SurveyAnswerItem = new Bean("com.cicro.wcm.bean.survey.SurveyAnswerItem",true);
		...
		$(document).ready(function () {		
			...
			{
				$("#showResultButton").attr("href","statisticsResult.jsp?s_id="+s_id);
