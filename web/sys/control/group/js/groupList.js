...
{
	top.OpenModalWindow("维护站群","/sys/control/group/group_add.jsp?parentID="+sgroup_id,500,300);
}

function openUpdateGroupPage()
{
	var selectIDS = table.getSelecteCheckboxValue("sgroup_id");
	top.OpenModalWindow("维护站群","/sys/control/group/group_add.jsp?parentID="+sgroup_id+"&sgroup_id="+selectIDS,500,300);
}

function openViewPage(s_id)
{
	top.OpenModalWindow("查看站群","/sys/control/group/group_view.jsp?sgroup_id="+s_id,500,300); 
}
