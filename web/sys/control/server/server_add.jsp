...
<table id="server_table" class="table_form" border="0" cellpadding="0" cellspacing="0">
	<tbody>
		<tr>
			...
			<td class="width250">
				<input id="server_name" name="server_name" type="text" class="width300" value="" onblur="checkInputValue('server_name',false,80,'服务器名称','')"/>
			</td>			
		</tr>
		<tr>
			<th><span class="f_red">*</span>RMIIP：</th>
			<td class="width250">
				<input id="server_ip" name="server_ip" type="text" class="width300" value="" onblur="checkInputValue('server_ip',false,80,'RMIIP','checkIP')"/>
			</td>			
		</tr>
        <tr>
            <th><span class="f_red">*</span>RMI端口：</th>
            <td class="width250">
                <input id="server_port" name="server_port" type="text" class="width300" value="" onblur="checkInputValue('server_port',false,80,'RMI端口','')"/>
            </td>
        </tr>
		<tr>
			<th><span class="f_red">*</span>服务器类型：</th>
			<td class="width250">
				<select id="server_type" name="server_type" class="width305">
		...
		<tr>
			...
			<td colspan="3">
				<textarea id="server_memo" name="server_memo" style="width:300px;;height:50px;" onblur="checkInputValue('server_memo',true,900,'备注','')"></textarea>		
			</td>
		</tr>
