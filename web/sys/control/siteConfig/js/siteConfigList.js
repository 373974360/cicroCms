...
function openAddPage(){ 
	top.OpenModalWindow("维护配置","/sys/control/siteConfig/siteConfig_add.jsp",500,160);
}

//打开修改页面
function openUpdatePage(){
	var selectIDS = table.getSelecteCheckboxValue("config_id");
	top.OpenModalWindow("维护配置","/sys/control/siteConfig/siteConfig_add.jsp?config_id="+selectIDS,500,160);
}
