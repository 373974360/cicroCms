...
{  
	top.OpenModalWindow("维护域名","/sys/control/site/domain_add.jsp?site_id="+site_id,460,130);
}
...
{  	
	...
	top.OpenModalWindow("维护域名","/sys/control/site/domain_add.jsp?site_id="+site_id+"&domain_id="+selectIDS,460,130);
}
