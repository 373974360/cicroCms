...
<body>
<div>
	<table id ="table" class="table_option" border="0" cellpadding="0" cellspacing="0" >
		<tr>
			<td align="left" valign="middle">
				<input id="btn1" name="btn1" type="button" onclick="openAddPage(site_id);" value="新建业务"/>
				<input id="btn1" name="btn1" type="button" onclick="updateRecord(table,'conf_id','openUpdatePage()');" value="修改" />
