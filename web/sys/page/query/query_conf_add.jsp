...
$(document).ready(function(){
	...
	{		
		...
		$("#saveBtn").click(updateQueryConf);
	}
	else
	{
		initData();
		$("#saveBtn").click(addQueryConf);
	}
});
...
<input type="hidden" id="site_id" name="site_id" value="<%=request.getParameter("site_id")%>"></input>
	...
	<tbody>
		<tr>
			...
			<td>
				...
				<input type="button" value="选择" onclick="openSelectTemplate('t_list_id','t_list_name',site_id)"/>
			</td>
		</tr>
	</tbody>
	<tbody>
		<tr>
			...
			<td>
				...
				<input type="button" value="选择" onclick="openSelectTemplate('t_content_id','t_content_name',site_id)"/>
			</td>
		</tr>
	</tbody>
	<tbody>
