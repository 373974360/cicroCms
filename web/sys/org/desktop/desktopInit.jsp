			...
			if("sq".equals(det.getApp_type()))
			{
				...
				switch(Integer.parseInt(det.getK_v()))
				{
					...
					case 1 :title = "转办件";
							...
							sq_con_map.put("is_back","0");//回退标识
							break;
					case 2 :url = "/sys/appeal/sq/sqList.jsp?sq_status=2&page_type=dsj";
							title = "待审件";
							sq_con_map.put("sq_status","2");//流程处理状态
							sq_con_map.put("page_type","dsj");//信件标识
							break;
					case 3 :url = "/sys/appeal/sq/sqList.jsp?sq_status=0,1&limit_flag=2&is_back=0&page_type=dsj";
							title = "延期待审";
							sq_con_map.put("sq_status","0,1");//流程处理状态
							sq_con_map.put("page_type","dsj");//信件标识
							sq_con_map.put("is_back","0");//回退标识
...
<style>
.sq_title2{ width:170px; height:22px; float:left; font-weight:bold; color:#606AA3;line-height:22px;}
.sq_title_right2{ width:160px; height:22px; line-height:22px; float:right;font-weight:bold; color:#606AA3; text-align:right; padding-right:10px;}
.new_sq_box{width:360px;float:left;margin-right:9px;margin-bottom:9px}
.table_view_desk{margin:0; border-collapse:collapse;}
