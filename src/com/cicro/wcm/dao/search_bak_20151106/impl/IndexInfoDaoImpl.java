...
/*    */   {
/* 26 */     return DBManager.queryFList("search.getInfoListBySiteIdPages", map);
/*    */   }
/*    */ 
/*    */   public int getInfoListBySiteIdCount(Map map)
/*    */   {
/* 35 */     return Integer.valueOf(((Integer)DBManager.queryFObj("search.getInfoListBySiteIdCount", map)).intValue()).intValue();
/*    */   }
/*    */ 
...
/* 46 */     return (Map)DBManager.queryFObj("search.getInfoById", map);
/*    */   }
/*    */ 
 ...
 * Qualified Name:     classes.com.cicro.wcm.dao.search.impl.IndexInfoDaoImpl
