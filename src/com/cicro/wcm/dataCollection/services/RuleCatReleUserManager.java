...
import com.cicro.wcm.dataCollection.bean.RuleCatReleUser;
import com.cicro.wcm.dataCollection.bean.RuleCategoryBean;
import com.cicro.wcm.dataCollection.dao.RuleCatReleUserDAO;
import com.cicro.wcm.services.org.group.GroupManager;
import com.cicro.wcm.services.system.ware.WareCategoryManager;
...
public class RuleCatReleUserManager implements ISyncCatch {
    ...
    public static void reloadRuleCatReleUser() {
        SyncCatchHandl.reladCatchForRMI("com.cicro.wcm.dataCollection.services.RuleCatReleUserManager");
    }
