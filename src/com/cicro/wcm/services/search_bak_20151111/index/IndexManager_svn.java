 ...
 * @version 1.0
 */  
public class IndexManager_svn {
    
	// 保存索引文件的地方
	static String indexDir = SearchForInterface.getIndexPathRoot();
	
	public static com.cicro.wcm.services.search.index.IndexService indexInfoService = new IndexInfoServiceImpl(); //一般信息类型的实现类
	public static com.cicro.wcm.services.search.index.IndexService indexPicService = new IndexPicServiceImpl(); //一般图文信息类型的实现类
	public static com.cicro.wcm.services.search.index.IndexService indexVideoService = new IndexVideoServiceImpl(); //一般视频信息类型的实现类
	public static com.cicro.wcm.services.search.index.IndexService indexXxgkService = new IndexXxgkServiceImpl(); //信息公开 一般信息类型的实现类
	public static com.cicro.wcm.services.search.index.IndexService indexFileService = new IndexFileServiceImpl(); //信息公开 法律法规文件类型的实现类
	public static com.cicro.wcm.services.search.index.IndexService indexLeaderService = new IndexLeaderServiceImpl(); //信息公开 领导成员类型的实现类
	public static com.cicro.wcm.services.search.index.IndexService indexOrgService = new IndexOrgServiceImpl(); //信息公开 下属机构类型的实现类
	public static com.cicro.wcm.services.search.index.IndexService indexOrgDService = new IndexOrgDServiceImpl(); //信息公 开机构概况 类型的实现类
	public static com.cicro.wcm.services.search.index.IndexService indexLawService = new IndexLawServiceImpl(); //信息公 开机构概况 类型的实现类
	public static com.cicro.wcm.services.search.index.IndexService indexBsznService = new IndexBsznServiceImpl(); //办事指南类型的实现类
	public static com.cicro.wcm.services.search.index.IndexService indexFwService = new IndexFwServiceImpl(); //服务的实现类
	
	public static com.cicro.wcm.services.search.index.IndexService indexCustomService = new IndexCustomServiceImpl(); //自定义表单信息 -- 一般信息
	public static com.cicro.wcm.services.search.index.IndexService indexCustomGkService = new IndexCustomGkServiceImpl();
	...
	public static void appendSingleDocument(Map map){
		IndexManager_svn.deleteSingleDocument(map);
