...
//			  }
			  indexBeanInfo.setId(com.cicro.util.FormatUtil.formatNullString((String)info.getId()));
			  indexBeanInfo.setTitle(com.cicro.util.FormatUtil.formatNullString((String)info.getTitle()));
			  indexBeanInfo.setApp_id(com.cicro.util.FormatUtil.formatNullString((String)info.getApp_id()));
			  indexBeanInfo.setUrl(com.cicro.util.FormatUtil.formatNullString((String)info.getUrl()));
			  indexBeanInfo.setSite_id(com.cicro.util.FormatUtil.formatNullString((String)info.getSite_id()));
			  
			  indexBeanInfo.setNode_id(com.cicro.util.FormatUtil.formatNullString((String)info.getSite_id()));
			  indexBeanInfo.setModel_id(com.cicro.util.FormatUtil.formatNullString(""+info.getModel_id()));
			  
			  indexBeanInfo.setCategoryId(com.cicro.util.FormatUtil.formatNullString((String)info.getCategoryId()));
			  ...
			  indexBeanInfo.setContent(HtmlRegexpUtil.filterHtml(com.cicro.util.FormatUtil.formatNullString((String)sb.toString())));
			  
			  indexBeanInfo.setIs_host(com.cicro.util.FormatUtil.formatNullString((String)info.getIs_host()));
