...
//				    	  }
			  ...
			  indexBeanBsznInfo.setId(com.cicro.util.FormatUtil.formatNullString((String)infoMap.get("info_id")));
			  indexBeanBsznInfo.setTitle(com.cicro.util.FormatUtil.formatNullString((String)infoMap.get("title")));
			  indexBeanBsznInfo.setApp_id(com.cicro.util.FormatUtil.formatNullString((String)infoMap.get("app_id")));
			  ...
			  indexBeanBsznInfo.setModel_id(com.cicro.util.FormatUtil.formatNullString((String)infoMap.get("model_id")));
			  
			  indexBeanBsznInfo.setBszn_type(com.cicro.util.FormatUtil.formatNullString((String)infoMap.get("gk_fwlb")));
			  indexBeanBsznInfo.setBszn_org(com.cicro.util.FormatUtil.formatNullString((String)infoMap.get("gk_bsjg")));
			  indexBeanBsznInfo.setBszn_object(com.cicro.util.FormatUtil.formatNullString((String)infoMap.get("gk_bldx")));
			  String time = ((String)infoMap.get("released_dtime"));  
			  time = time == null ? "" : time.replaceAll("-","").replaceAll(" ", "").replaceAll(":","");
			  indexBeanBsznInfo.setPublish_time(com.cicro.util.FormatUtil.formatNullString(time)); 
			  indexBeanBsznInfo.setCategoryId(com.cicro.util.FormatUtil.formatNullString((String)infoMap.get("cat_id")));
			  indexBeanBsznInfo.setIs_host(com.cicro.util.FormatUtil.formatNullString((String)infoMap.get("is_host")));
