...
import com.cicro.wcm.dao.search.impl.IndexResourcePdfDaoImpl;
...
import com.cicro.wcm.services.search.util.pdf.PdfManager;
	...
	*/
	...
	public static IndexBeanInfo getIndexBeanInfo(String[] infoLis){
		 ...
		 try{
			  ...
			  indexBeanInfo.setId(com.cicro.util.FormatUtil.formatNullString(infoLis[2]));
			  indexBeanInfo.setTitle(com.cicro.util.FormatUtil.formatNullString(infoLis[0]));
			  indexBeanInfo.setApp_id(com.cicro.util.FormatUtil.formatNullString("cms"));
			  ...
			  indexBeanInfo.setContent(HtmlRegexpUtil.filterHtml(com.cicro.util.FormatUtil.formatNullString(sbContent.toString())));
