...
//				    	  }
			  ...
			  indexBeanFile.setId(com.cicro.util.FormatUtil.formatNullString((String)infoMap.get("info_id")));
			  indexBeanFile.setTitle(com.cicro.util.FormatUtil.formatNullString((String)infoMap.get("title")));
			  indexBeanFile.setApp_id(com.cicro.util.FormatUtil.formatNullString((String)infoMap.get("app_id")));
			  indexBeanFile.setContent(HtmlRegexpUtil.filterHtml(com.cicro.util.FormatUtil.formatNullString((String)infoMap.get("gk_content"))));
			  indexBeanFile.setUrl(com.cicro.util.FormatUtil.formatNullString((String)infoMap.get("content_url")));
			  String site_id = com.cicro.wcm.services.control.site.SiteAppRele.getSiteIDByAppID("zwgk");
			  indexBeanFile.setSite_id(site_id); 
			  
			  indexBeanFile.setNode_id(com.cicro.util.FormatUtil.formatNullString((String)infoMap.get("site_id")));

			  indexBeanFile.setModel_id(com.cicro.util.FormatUtil.formatNullString((String)infoMap.get("model_id")));
			  
			  indexBeanFile.setWnumber(com.cicro.util.FormatUtil.formatNullString((String)infoMap.get("doc_no")));
			  indexBeanFile.setCode(com.cicro.util.FormatUtil.formatNullString((String)infoMap.get("gk_index")));
			  String time = ((String)infoMap.get("released_dtime"));
			  time = time == null ? "" : time.replaceAll("-","").replaceAll(" ", "").replaceAll(":","");
			  indexBeanFile.setPublish_time(com.cicro.util.FormatUtil.formatNullString(time)); 
			  time = ((String)infoMap.get("generate_dtime")); 
			  time = time == null ? "" : time.replaceAll("-","").replaceAll(" ", "").replaceAll(":","");
			  indexBeanFile.setC_time(com.cicro.util.FormatUtil.formatNullString(time)); 
			  time = ((String)infoMap.get("effect_dtime"));
			  time = time == null ? "" : time.replaceAll("-","").replaceAll(" ", "").replaceAll(":","");
			  indexBeanFile.setTake_time(com.cicro.util.FormatUtil.formatNullString(time)); 
			  time = ((String)infoMap.get("aboli_dtime"));
			  time = time == null ? "" : time.replaceAll("-","").replaceAll(" ", "").replaceAll(":","");
			  indexBeanFile.setOver_time(com.cicro.util.FormatUtil.formatNullString(time)); 
			  indexBeanFile.setObject_words(com.cicro.util.FormatUtil.formatNullString((String)infoMap.get("topic_key")));
			  indexBeanFile.setForm_type(com.cicro.util.FormatUtil.formatNullString((String)infoMap.get("theme_name")));
			  indexBeanFile.setContent_type(com.cicro.util.FormatUtil.formatNullString((String)infoMap.get("topic_name")));
			  indexBeanFile.setPublish_org(com.cicro.util.FormatUtil.formatNullString((String)infoMap.get("gk_input_dept")));
			  indexBeanFile.setCategoryId(com.cicro.util.FormatUtil.formatNullString((String)infoMap.get("cat_id")));
			  indexBeanFile.setIs_host(com.cicro.util.FormatUtil.formatNullString((String)infoMap.get("is_host")));
