package com.cicro.wcm.services.search_bak_20151111.util.autokeys;
...
import com.cicro.wcm.services.search.util.autokeys.*;
...
public class BaiduResult {
	...
	public static List<String> getBaiduResult(String str_2){
		...
		try{
			...
			String result_baidu = com.cicro.wcm.services.search.util.autokeys.FileDown.getBaiduResult(url_baidu);
