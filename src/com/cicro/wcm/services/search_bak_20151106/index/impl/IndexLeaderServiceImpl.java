...
/*     */ 
/*     */ public class IndexLeaderServiceImpl
/*     */   implements IndexService
/*     */ {
/*  33 */   static int s_count = 50;
/*  34 */   static IIndexInfoDao indexInfoDao = new IndexLeaderDaoImpl();
/*     */ 
...
/*     */ 
/*  91 */         List infoList = s.selectList(DBManager.getSqlNameByDataType("search.getLeaderListBySiteIdPages"), mapSite);
/*     */ 
...
/* 198 */         Map map = (Map)s.selectOne(DBManager.getSqlNameByDataType("search.getLeaderById"), mapC);
/*     */ 
/* 200 */         if (map == null) {
/* 201 */           return false;
/*     */         }
...
/*     */         } else {
/* 243 */           typeField.setValue(IndexBeanXxgkInfo.getType());
/* 244 */           doc.add(typeField);
/* 245 */           typedField.setValue(indexBeanXxgk.getTyped());
...
/* 399 */       sb.append(FormatUtil.formatNullString((String)infoMap.get("gk_ldzw")));
/* 400 */       sb.append(FormatUtil.formatNullString((String)infoMap.get("gk_grjl")));
/* 401 */       sb.append(FormatUtil.formatNullString((String)infoMap.get("gk_gzfg")));
 ...
 * Qualified Name:     classes.com.cicro.wcm.services.search.index.impl.IndexLeaderServiceImpl
