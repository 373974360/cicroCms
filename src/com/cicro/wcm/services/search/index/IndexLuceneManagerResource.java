package com.cicro.wcm.services.search.index;
...
public class IndexLuceneManagerResource {

    // 保存索引文件的地方
    static String indexDir = SearchForInterface.getIndexPathRoot() + "_resource";
    ...
    public static void setDirectory(Directory dirTemp) {
        dir = dirTemp;
    }
    ...
    public static IndexWriter getIndexModifier(boolean isNew) throws CorruptIndexException, LockObtainFailedException, IOException {
        ...
        IndexWriter indexWriter = new IndexWriter(dir, new IKAnalyzer(), isNew, IndexWriter.MaxFieldLength.UNLIMITED);
