package com.cicro.wcm.filter;

import com.cicro.util.Javascript;
import com.cicro.util.jspFilterHandl;
...
public class ManagerLoginFilter implements javax.servlet.Filter {
    ...
    public void doFilter(ServletRequest _request, ServletResponse _response,
        ...
        if(request instanceof HttpServletRequest && requestUri.indexOf("ueditor/jsp/controller.jsp") < 0 && requestUri.indexOf("servlet/UploadFileIfy") < 0) {
