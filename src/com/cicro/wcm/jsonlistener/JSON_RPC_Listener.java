package com.cicro.wcm.jsonlistener;
...
import com.cicro.util.io.*;
import com.cicro.util.jconfig.*;
...
static {
  try { String classList = FileOperation.readFileToString(JconfigUtilContainer.bashConfig().getProperty("path", "", "jsonrpcFile"));
    ...
    RPC_ACTIONS.add(new RPC_Action("JSONUtil", "com.cicro.wcm.jsonlistener.JSONUtil"));
    ...
    BRPC_ACTIONS.add(new RPC_Action("JSONUtil", "com.cicro.wcm.jsonlistener.JSONUtil"));
  } catch (Exception e) {
    e.printStackTrace();
  }
}
...
public void requestInitialized(ServletRequestEvent sre) {
  ...
  if (this.request.getRequestURI().endsWith("/manager/JSON-RPC"))
  {
