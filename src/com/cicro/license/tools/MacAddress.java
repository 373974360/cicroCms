...
/*    */ 
/* 28 */     new Thread(process) {
/*    */       public void run() {
/*    */         try {
/* 31 */           InputStream errorStream = MacAddress.this.getErrorStream();
/* 32 */           while (errorStream.read() != -1);
/* 33 */           errorStream.close();
/*    */         } catch (IOException e) {
 ...
 * Qualified Name:     com.cicro.license.tools.MacAddress
