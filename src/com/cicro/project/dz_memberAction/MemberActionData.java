...
public class MemberActionData {
	...
	public static void getMemberActionSearchCon(String params, Map<String, String> con_map) {
		String orderby = "clickTime desc";
	...
	public static TurnPageBean getMemberActionCount(String params) {
		Map con_map = new HashMap();
		getMemberActionSearchCon(params, con_map);

		TurnPageBean tpb = new TurnPageBean();
		tpb.setCount(Integer.parseInt(MemberActionManager.getMemberActionCount(con_map)));
	...
	public static List<MemberActionBean> getMemberActionList(String params) {
		Map con_map = new HashMap();
		getMemberActionSearchCon(params, con_map);
		...
		return MemberActionManager.getMemberActionList(con_map);
	}

	public static List<MemberActionBean> getMemberActionHotList(String params) {
		Map con_map = new HashMap();
		getMemberActionSearchCon(params, con_map);
	...
	public static MemberActionBean getMemberActionObject(String id) {
		return MemberActionManager.getMemberActionBean(id);
	}
}