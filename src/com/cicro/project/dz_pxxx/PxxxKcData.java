...
/*     */ 
/*     */ public class PxxxKcData
/*     */ {
/*  13 */   private static int cur_page = 1;
/*  14 */   private static int page_size = 15;
/*     */ 
/*     */   public static void getPxxxKcSearchCon(String params, Map<String, String> con_map)
/*     */   {
...
/* 104 */     System.out.println(con_map);
/*     */   }
/*     */ 
/*     */   public static TurnPageBean getPxxxKcCount(String params)
/*     */   {
/* 109 */     Map con_map = new HashMap();
/* 110 */     getPxxxKcSearchCon(params, con_map);
/*     */ 
/* 112 */     TurnPageBean tpb = new TurnPageBean();
/* 113 */     tpb.setCount(Integer.parseInt(PxxxKcManager.getPxxxKcCount(con_map)));
...
/*     */   }
/*     */ 
/*     */   public static List<PxxxKcBean> getPxxxKcList(String params) {
/* 143 */     Map con_map = new HashMap();
/* 144 */     getPxxxKcSearchCon(params, con_map);
...
/* 149 */     return PxxxKcManager.getPxxxKcList(con_map);
/*     */   }
/*     */ 
/*     */   public static List<PxxxKcBean> getAllPxxxKcList(String params) {
/* 153 */     return PxxxKcManager.getAllPxxxKcList();
/*     */   }
/*     */ 
/*     */   public static List<PxxxKcBean> getPxxxKcHotList(String params) {
/* 157 */     Map con_map = new HashMap();
/* 158 */     getPxxxKcSearchCon(params, con_map);
...
/* 164 */     return PxxxKcManager.getPxxxKcList(con_map);
/*     */   }
...
/*    */   }
/*     */ 
/*     */   public static PxxxKcBean getPxxxKcObject(String id)
/*     */   {
/* 169 */     return PxxxKcManager.getPxxxKcBean(id);
/*     */   }
/*     */ }

/* Location:           E:\Xshell\219.144.222.46(省水保)\classes\com.zip
 * Qualified Name:     com.cicro.project.sb_xmgl.Sb_xmglData
