...
public class PxxxBmRPC {
    ...
    public static List<PxxxBmBean> isExist(Map<String, String> m) {
        return PxxxBmManager.isExistByPxIdAndNameId(m);
    }
    ...
    public static PxxxBmBean updatePxxxBm(PxxxBmBean hb, HttpServletRequest request) {
    ...
    public static PxxxBmBean insertPxxxBm(PxxxBmBean hb, HttpServletRequest request) {
        SettingLogsBean stl = LogManager.getSettingLogsByRequest(request);
        if (stl != null) {
