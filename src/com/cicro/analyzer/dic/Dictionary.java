...
public class Dictionary {
	 ...
	 * 分词器默认字典路径 
	 */
	public static final String PATH_DIC_MAIN = "/com/cicro/analyzer/dic/main.dic";   //建立一个主词典实例
	public static final String PATH_DIC_SURNAME = "/com/cicro/analyzer/dic/surname.dic";  //加载姓氏词典
	public static final String PATH_DIC_QUANTIFIER = "/com/cicro/analyzer/dic/quantifier.dic"; //加载量词词典
	public static final String PATH_DIC_SUFFIX = "/com/cicro/analyzer/dic/suffix.dic";  //建立一个后缀词典实例
	public static final String PATH_DIC_PREP = "/com/cicro/analyzer/dic/preposition.dic";  //加载介词\副词词典
	public static final String PATH_DIC_STOP = "/com/cicro/analyzer/dic/stopword.dic";   //加载停止词词典
	
	public static final String PATH_DIC_FILES = "/com/cicro/analyzer/dic/files/"; //扩展词库的存放路径
	...
	private void loadMainFiles(){
		 try{   
		    String fileRoot = "";
		    //System.out.println(PATH_DIC_FILES);
		    fileRoot = new AnalyzerManager()
		           .getClass().
		                 getResource(PATH_DIC_FILES).
		                   getPath();
		    //System.out.println(fileRoot);
		    //fileRoot = "D:\\cicro\\Eclipse8_work\\wcm\\WebRoot\\WEB-INF\\classes\\com\\cicro\\analyzer\\dic\\files";
		    File fileR = new File(fileRoot);
		    if(fileR.exists()){
		    	File[] file = fileR.listFiles();
		    	for(File f : file){
		    		String strFile = f.getCanonicalFile().toString();
	...
	private void loadStopWordDict(){
		...
		try {
			...
			do {
				theWord = br.readLine();
				if (theWord != null && !"".equals(theWord.trim())) {
					//if(!_MainDict.getSegment(theWord.trim().toCharArray())){
